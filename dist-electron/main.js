...
var W = (e, t, r) => (Cs(e, t, "read from private field"), r ? r.call(e) : t.get(e)), Je = (e, t, r) => t.has(e) ? Pi("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Me = (e, t, r, n) => (Cs(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r), mt = (e, t, r) => (Cs(e, t, "access private method"), r);
import sl, { clipboard as Ar, ipcMain as at, nativeImage as al, app as Er, globalShortcut as ol, Tray as Nd, Menu as Rd, BrowserWindow as il } from "electron";
import { fileURLToPath as Od } from "node:url";
import ee from "node:path";
import fe from "node:process";
import { promisify as Ne, isDeepStrictEqual as Ni } from "node:util";
...
const kt = cl.homedir(), Pa = cl.tmpdir(), { env: br } = fe, Dd = (e) => {
...
}, zd = fe.getuid ? !fe.getuid() : !1, Re = {
  isRetriable: Sr.isRetriableError
}, Te = {
  attempt: {
    /* ASYNC */
    chmod: bt(Ne(Y.chmod), Nn),
    chown: bt(Ne(Y.chown), Nn),
    ...
    /* SYNC */
    chmodSync: pt(Y.chmodSync, Nn),
    chownSync: pt(Y.chownSync, Nn),
...
fe.getuid && fe.getuid();
const Ti = 128, Jd = (e) => e instanceof Error && "code" in e, ji = (e) => typeof e == "string", Vs = (e) => e === void 0, Wd = fe.platform === "linux", fl = fe.platform === "win32", Na = ["SIGHUP", "SIGINT", "SIGTERM"];
fl || Na.push("SIGALRM", "SIGABRT", "SIGVTALRM", "SIGXCPU", "SIGXFSZ", "SIGUSR2", "SIGTRAP", "SIGSYS", "SIGQUIT", "SIGIOT");
Wd && Na.push("SIGIO", "SIGPOLL", "SIGPWR", "SIGSTKFLT");
class Yd {
  /* CONSTRUCTOR */
  constructor() {
...
const Qd = new Yd(), Zd = Qd.register, je = {
  /* VARIABLES */
  store: {},
  // filePath => purge
  /* API */
...
function hl(e, t, r = Kd) {
  ...
  try {
    ...
    l = Te.retry.openSync(s)(o, "w", r.mode || Ii), r.tmpCreated && r.tmpCreated(o), ji(t) ? Te.retry.writeSync(s)(l, t, 0, r.encoding || Ud) : Vs(t) || Te.retry.writeSync(s)(l, t, 0, t.length, 0), r.fsync !== !1 && (r.fsyncWait !== !1 ? Te.retry.fsyncSync(s)(l) : Te.attempt.fsync(l)), Te.retry.closeSync(s)(l), l = null, r.chown && (r.chown.uid !== Gd || r.chown.gid !== Hd) && Te.attempt.chownSync(o, r.chown.uid, r.chown.gid), r.mode && r.mode !== Ii && Te.attempt.chmodSync(o, r.mode);
    try {
...
var oa = { exports: {} }, pl = {}, tt = {}, Cr = {}, gn = {}, Q = {}, yn = {};
(function(e) {
...
Cr.topBoolOrEmptySchema = pf;
function yf(e, t) {
  const { gen: r, schema: n } = e;
  n === !1 ? (r.var(t, !1), wl(e)) : r.var(t, !0);
}
Cr.boolOrEmptySchema = yf;
function wl(e, t) {
...
const Ef = fr, bf = $t, Sf = gn, Z = Q, Sl = A;
var Rr;
(function(e) {
...
function Jf(e, t) {
  ...
  function _(m = t.async ? (0, ke._)`await ` : ke.nil) {
    ...
    n.assign(h, (0, ke._)`${m}${(0, Hf.callValidateCode)(e, u, v, N)}`, t.modifying);
  }
  function $(m) {
    var v;
...
function Wf(e, t) {
  ...
  r.if((0, ke._)`Array.isArray(${t})`, () => {
    r.assign(tr.default.vErrors, (0, ke._)`${tr.default.vErrors} === null ? ${t} : ${tr.default.vErrors}.concat(${t})`).assign(tr.default.errors, (0, ke._)`${tr.default.vErrors}.length`), (0, Xf.extendErrors)(e);
  }, () => e.error());
}
...
function eh(e, t, { dataProp: r, dataPropType: n, data: s, dataTypes: a, propertyName: o }) {
  ...
  if (r !== void 0) {
    ...
    c(E), e.errorPath = (0, ct.str)`${d}${(0, Tl.getErrorPath)(r, n, h.jsPropertySyntax)}`, e.parentDataProperty = (0, ct._)`${r}`, e.dataPathArr = [...u, e.parentDataProperty];
  }
  if (s !== void 0) {
...
function hh(e, t) {
  if (typeof e == "boolean")
    return {};
  const { schemaId: r, uriResolver: n } = this.opts, s = Or(e[r] || t), a = { "": s }, o = Al(n, s, !1), l = {}, c = /* @__PURE__ */ new Set();
...
const Dl = Cr, Mi = ge, Ca = $t, as = ge, mh = ps, an = ut, Ls = Vt, U = Q, X = Ke, ph = Se, gt = A, Qr = gn;
function yh(e) {
  if (Ll(e) && (Fl(e), Vl(e))) {
    _h(e);
    return;
...
const We = Q, Fh = _n, xt = Ke, xe = Se, zi = A, zh = tt;
let $s = class {
  constructor(t) {
    var r;
...
const Xh = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", Bh = "Meta-schema for $data reference (JSON AnySchema extension proposal)", Jh = "object", Wh = [
  "$data"
], Yh = {
  $data: {
    type: "string",
...
function Nm(e, t, r) {
  const n = r ? Object.assign({ scheme: "null" }, r) : { scheme: "null" }, s = ru(wt(e, n), wt(t, n), n, !0);
...
function Rm(e, t, r) {
  return typeof e == "string" ? (e = unescape(e), e = dt(Rn(wt(e, r), !0), { ...r, skipEscape: !0 })) : typeof e == "object" && (e = dt(Rn(e, !0), { ...r, skipEscape: !0 })), typeof t == "string" ? (t = unescape(t), t = dt(Rn(wt(t, r), !0), { ...r, skipEscape: !0 })) : typeof t == "object" && (t = dt(Rn(t, !0), { ...r, skipEscape: !0 })), e.toLowerCase() === t.toLowerCase();
}
function dt(e, t) {
  const r = {
    host: e.host,
...
(function(e) {
  ...
  const n = _n, s = Lr, a = fr, o = Ce, l = Q, c = Se, d = ge, u = A, h = Zh, E = Va, g = (P, p) => new RegExp(P, p);
  g.code = "new RegExp";
  ...
  function N(P) {
    ...
    const Be = P.strict, Zt = (p = P.code) === null || p === void 0 ? void 0 : p.optimize, Br = Zt === !0 || Zt === void 0 ? 1 : Zt || 0, Jr = (y = (S = P.code) === null || S === void 0 ? void 0 : S.regExp) !== null && y !== void 0 ? y : g, As = (i = P.uriResolver) !== null && i !== void 0 ? i : E.default;
    return {
      ...
      code: P.code ? { ...P.code, optimize: Br, regExp: Jr } : { optimize: Br, regExp: Jr },
...
const Tm = Lr, qi = re, Le = Q, yr = Ke, Ki = Ce, On = A, jm = {
  keyword: "$ref",
  schemaType: "string",
  code(e) {
...
function Wn(e, t, r, n) {
  ...
  function u() {
    ...
    const w = s.let("valid");
    s.try(() => {
      s.code((0, Le._)`await ${(0, qi.callValidateCode)(e, t, d)}`), g(t), o || s.assign(w, !0);
    }, (_) => {
...
const rr = Q, Fm = A, zm = Ba, Um = {
  ...
  error: Um,
  code(e) {
    const { keyword: t, data: r, schemaCode: n, it: s } = e, a = t === "maxLength" ? rr.operators.GT : rr.operators.LT, o = s.opts.unicode === !1 ? (0, rr._)`${r}.length` : (0, rr._)`${(0, Fm.useFunc)(e.gen, zm.default)}(${r})`;
...
const Km = re, Gm = A, Pr = Q, Hm = {
  ...
  code(e) {
    ...
    if (n) {
      const { regExp: c } = o.opts.code, d = c.code === "new RegExp" ? (0, Pr._)`new RegExp` : (0, Gm.useFunc)(t, c), u = t.let("valid");
...
const Us = ge, Ee = Q, ep = A, tp = vn, rp = {
  ...
  code(e) {
    ...
    function E(w, _) {
      const $ = t.name("item"), m = (0, Us.checkDataTypes)(d, $, l.opts.strictNumbers, Us.DataType.Wrong), v = t.const("indices", (0, Ee._)`{}`);
      t.for((0, Ee._)`;${w}--;`, () => {
...
const fp = Ga, hp = Ha, mp = Xa, pp = Ja, yp = Wa, $p = Ya, gp = Qa, _p = Za, vp = xa, wp = eo, Ep = [
  // number
  fp.default,
  hp.default,
  // string
...
const Hi = Q, Ip = A, Tp = re, jp = Fr, kp = {
...
const Tn = re, Qe = Q, Fp = Ke, jn = A, zp = {
  ...
  code(e) {
    ...
    h(), e.ok((0, Qe._)`${a} === ${Fp.default.errors}`);
    function h() {
      t.forIn("key", s, ($) => {
...
const Ji = re, kn = Q, Wi = A, Yi = A, Gp = {
  keyword: "patternProperties",
  type: "object",
  schemaType: "object",
  code(e) {
    const { gen: t, schema: r, data: n, parentSchema: s, it: a } = e, { opts: o } = a, l = (0, Ji.allSchemaProperties)(r), c = l.filter((_) => (0, Wi.alwaysValidSchema)(a, r[_]));
...
const sy = Fr, ay = ro, oy = zr, iy = no, cy = so, ly = vs, uy = ao, dy = ws, fy = oo, hy = io, my = co, py = lo, yy = uo, $y = fo, gy = ho, _y = mo;
function vy(e = !1) {
  const t = [
    // any
    my.default,
...
const Ks = Q, wy = Ke, Zi = Ce, Ey = Et, by = {
...
const ky = Ur, Ay = qr, Cy = yo, Dy = $o, My = [ky.default, Ay.default, Cy.default, Dy.default];
po.default = My;
var go = {}, _o = {};
...
const Tt = Q, rc = A, Xy = Ke, By = {
  ...
  code(e) {
    ...
    l instanceof Tt.Name ? t.if((0, Tt._)`${l} !== true`, () => t.forIn("key", n, (h) => t.if(d(l, h), () => c(h)))) : l !== !0 && t.forIn("key", n, (h) => l === void 0 ? c(h) : t.if(u(l, h), () => c(h))), a.props = !0, e.ok((0, Tt._)`${s} === ${Xy.default.errors}`);
    function c(h) {
      if (r === !1) {
...
const sr = Q, nc = A, Wy = {
  ...
  code(e) {
    ...
    function l(c, d) {
      t.forRange("i", d, o, (u) => {
        e.subschema({ keyword: "unevaluatedItems", dataProp: u, dataPropType: nc.Type.Num }, c), s.allErrors || t.if((0, sr.not)(c), () => t.break());
      });
    }
  }
};
...
Object.defineProperty(za, "__esModule", { value: !0 });
const s$ = Ua, a$ = Ka, o$ = to, i$ = po, c$ = go, l$ = Eo, u$ = Po, sc = Dr, d$ = [
  i$.default,
  s$.default,
  a$.default,
  (0, o$.default)(!0),
...
Object.defineProperty(Ro, "__esModule", { value: !0 });
const vr = Q, ha = Es, oc = Ce, f$ = Lr, h$ = A, m$ = {
...
const y$ = "https://json-schema.org/draft/2020-12/schema", $$ = "https://json-schema.org/draft/2020-12/schema", g$ = {
  ...
  "https://json-schema.org/draft/2020-12/vocab/content": !0
}, X$ = "meta", B$ = "Content vocabulary meta-schema", J$ = [
  "object",
  "boolean"
], W$ = {
  contentEncoding: {
...
var pu = {}, pa = { exports: {} }, yu = {}, rt = {}, Mr = {}, wn = {}, te = {}, $n = {};
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 }), e.regexpCode = e.getEsmExportName = e.getProperty = e.safeStringify = e.stringify = e.strConcat = e.addCodeArg = e.str = e._ = e.nil = e._Code = e.Name = e.IDENTIFIER = e._CodeOrName = void 0;
  class t {
  }
...
_t.schemaHasRulesForType = lg;
function bu(e, t) {
  return t.rules.some((r) => Su(e, r));
}
_t.shouldUseGroup = bu;
function Su(e, t) {
  var r;
  return e[t.keyword] !== void 0 || ((r = t.definition.implements) === null || r === void 0 ? void 0 : r.some((n) => e[n] !== void 0));
}
...
const ug = hr, dg = _t, fg = wn, x = te, Pu = C;
var Ir;
(function(e) {
  e[e.Correct = 0] = "Correct", e[e.Wrong = 1] = "Wrong";
})(Ir || (_e.DataType = Ir = {}));
...
function Mg(e, t) {
  ...
  function _(m = t.async ? (0, Ae._)`await ` : Ae.nil) {
    ...
    n.assign(h, (0, Ae._)`${m}${(0, Ag.callValidateCode)(e, u, v, N)}`, t.modifying);
  }
  function $(m) {
    var v;
...
function Vg(e, t) {
  ...
  r.if((0, Ae._)`Array.isArray(${t})`, () => {
    r.assign(ar.default.vErrors, (0, Ae._)`${ar.default.vErrors} === null ? ${t} : ${ar.default.vErrors}.concat(${t})`).assign(ar.default.errors, (0, Ae._)`${ar.default.vErrors}.length`), (0, Cg.extendErrors)(e);
  }, () => e.error());
}
...
function qg(e, t, { dataProp: r, dataPropType: n, data: s, dataTypes: a, propertyName: o }) {
  ...
  if (r !== void 0) {
    ...
    c(E), e.errorPath = (0, lt.str)`${d}${(0, ju.getErrorPath)(r, n, h.jsPropertySyntax)}`, e.parentDataProperty = (0, lt._)`${r}`, e.dataPathArr = [...u, e.parentDataProperty];
  }
  if (s !== void 0) {
...
Lt.extendSubschemaData = qg;
function Kg(e, { jtdDiscriminator: t, jtdMetadata: r, compositeRule: n, createErrors: s, allErrors: a }) {
  n !== void 0 && (e.compositeRule = n), s !== void 0 && (e.createErrors = s), a !== void 0 && (e.allErrors = a), e.jtdDiscriminator = t, e.jtdMetadata = r;
}
Lt.extendSubschemaMode = Kg;
var Pe = {}, ku = { exports: {} }, Mt = ku.exports = function(e, t, r) {
  typeof t == "function" && (r = t, t = {}), r = t.cb || r;
  var n = typeof r == "function" ? r : r.pre || function() {
  }, s = r.post || function() {
  };
...
const Xg = C, Bg = ys, Jg = Hg, Wg = /* @__PURE__ */ new Set([
  "type",
  "format",
  "pattern",
  "maxLength",
...
function Au(e) {
  ...
  for (const r in e) {
    if (r === "$ref")
      return 1 / 0;
    if (t++, !Wg.has(r) && (typeof e[r] == "object" && (0, Xg.eachItem)(e[r], (n) => t += Au(n)), t === 1 / 0))
      return 1 / 0;
  }
  return t;
}
...
function t_(e, t) {
  if (typeof e == "boolean")
    return {};
  const { schemaId: r, uriResolver: n } = this.opts, s = Tr(e[r] || t), a = { "": s }, o = Cu(n, s, !1), l = {}, c = /* @__PURE__ */ new Set();
...
const Mu = Mr, dc = _e, Mo = _t, us = _e, r_ = bs, dn = ft, Gs = Lt, q = te, B = ht, n_ = Pe, vt = C, xr = wn;
function s_(e) {
  if (Fu(e) && (zu(e), Lu(e))) {
    i_(e);
    return;
...
const Ye = te, R_ = En, er = ht, et = Pe, pc = C, O_ = rt;
class Ss {
  constructor(t) {
    var r;
    this.refs = {}, this.dynamicAnchors = {};
...
(function(e) {
  ...
  const n = En, s = Kr, a = hr, o = ze, l = te, c = Pe, d = _e, u = C, h = z_, E = Fo, g = (P, p) => new RegExp(P, p);
  g.code = "new RegExp";
  const w = ["removeAdditional", "useDefaults", "coerceTypes"], _ = /* @__PURE__ */ new Set([
    "validate",
    "serialize",
...
const q_ = Kr, yc = ne, Fe = te, gr = ht, $c = ze, An = C, K_ = {
  keyword: "$ref",
  schemaType: "string",
  code(e) {
    const { gen: t, schema: r, it: n } = e, { baseId: s, schemaEnv: a, validateName: o, opts: l, self: c } = n, { root: d } = a;
...
function xn(e, t, r, n) {
  ...
  function u() {
    ...
    const w = s.let("valid");
    s.try(() => {
      s.code((0, Fe._)`await ${(0, yc.callValidateCode)(e, t, d)}`), g(t), o || s.assign(w, !0);
    }, (_) => {
...
const or = te, Q_ = C, Z_ = Bo, x_ = {
  ...
  error: x_,
  code(e) {
    const { keyword: t, data: r, schemaCode: n, it: s } = e, a = t === "maxLength" ? or.operators.GT : or.operators.LT, o = s.opts.unicode === !1 ? (0, or._)`${r}.length` : (0, or._)`${(0, Q_.useFunc)(e.gen, Z_.default)}(${r})`;
...
const tv = ne, rv = C, Nr = te, nv = {
  ...
  code(e) {
    const { gen: t, data: r, $data: n, schema: s, schemaCode: a, it: o } = e, l = o.opts.unicodeRegExp ? "u" : "";
    if (n) {
      const { regExp: c } = o.opts.code, d = c.code === "new RegExp" ? (0, Nr._)`new RegExp` : (0, rv.useFunc)(t, c), u = t.let("valid");
...
const Bs = _e, be = te, fv = C, hv = bn, mv = {
...
const Sv = Go, Pv = Ho, Nv = Xo, Rv = Jo, Ov = Wo, Iv = Yo, Tv = Qo, jv = Zo, kv = xo, Av = ei, Cv = [
  // number
  Sv.default,
  Pv.default,
  // string
...
const _c = te, Uv = C, qv = ne, Kv = Gr, Gv = {
...
const Dn = ne, Ze = te, Qv = ht, Mn = C, Zv = {
  message: "must NOT have additional properties",
  ...
  code(e) {
    ...
    h(), e.ok((0, Ze._)`${a} === ${Qv.default.errors}`);
    function h() {
      t.forIn("key", s, ($) => {
        !d.length && !u.length ? w($) : t.if(E($), () => w($));
      });
...
const ew = rt, vc = ne, Js = C, wc = Ns, tw = {
  keyword: "properties",
  type: "object",
  schemaType: "object",
  code(e) {
...
const yw = Gr, $w = ri, gw = Hr, _w = ni, vw = si, ww = ed, Ew = ai, bw = Ns, Sw = oi, Pw = ii, Nw = ci, Rw = li, Ow = ui, Iw = di, Tw = fi, jw = hi;
function kw(e = !1) {
  const t = [
    // any
    Nw.default,
...
Object.defineProperty(zo, "__esModule", { value: !0 });
const Vw = Uo, Lw = Ko, Fw = ti, zw = mi, Nc = Vr, Uw = [
  Vw.default,
  Lw.default,
  (0, Fw.default)(),
  zw.default,
...
const wr = te, Ea = Rs, Oc = ze, qw = Kr, Kw = C, Gw = {
...
yi.default = Hw;
const Xw = "http://json-schema.org/draft-07/schema#", Bw = "http://json-schema.org/draft-07/schema#", Jw = "Core schema meta-schema", Ww = {
  schemaArray: {
    type: "array",
    minItems: 1,
    items: {
...
const Ln = Is, { MAX_LENGTH: jc, MAX_SAFE_INTEGER: Fn } = Os, { safeRe: zn, t: Un } = Sn, vE = $i, { compareIdentifiers: Ws } = ad;
let wE = class ot {
  constructor(t, r) {
    if (r = vE(r), t instanceof ot) {
...
var kE = jE;
const AE = De, CE = (e, t) => new AE(e, t).major;
var DE = CE;
const ME = De, VE = (e, t) => new ME(e, t).minor;
var LE = VE;
const FE = De, zE = (e, t) => new FE(e, t).patch;
var UE = zE;
const qE = Xr, KE = (e, t) => {
  const r = qE(e, t);
...
var GE = KE;
const Dc = De, HE = (e, t, r) => new Dc(e, r).compare(new Dc(t, r));
var nt = HE;
const XE = nt, BE = (e, t, r) => XE(t, e, r);
var JE = BE;
const WE = nt, YE = (e, t) => WE(e, t, !0);
var QE = YE;
const Mc = De, ZE = (e, t, r) => {
...
var cd = bb;
const Sb = De, Pb = Xr, { safeRe: qn, t: Kn } = Sn, Nb = (e, t) => {
  if (e instanceof Sb)
    return e;
...
function st() {
  ...
  Ys = t;
  const r = Ib, n = new r(), s = $i, a = js(), o = Is, l = De, {
    safeRe: c,
    t: d,
...
function js() {
  ...
  Qs = t;
  const r = $i, { safeRe: n, t: s } = Sn, a = cd, o = Is, l = De, c = st();
  return Qs;
}
...
var qb = Ub;
const Zs = De, Kb = st(), Fc = Ts, Gb = (e, t) => {
  e = new Kb(e, t);
  let r = new Zs("0.0.0");
...
var Jb = Bb;
const Wb = De, ld = js(), { ANY: Yb } = ld, Qb = st(), Zb = ks, zc = Ts, Uc = _i, xb = wi, eS = vi, tS = (e, t, r, n) => {
  e = new Wb(e, n), t = new Qb(t, n);
  let s, a, o, l, c;
  switch (r) {
    case ">":
      s = zc, a = xb, o = Uc, l = ">", c = ">=";
...
var yS = hS;
const ea = Sn, Bc = Os, $S = De, Jc = ad, gS = Xr, _S = PE, vS = OE, wS = TE, ES = kE, bS = DE, SS = LE, PS = UE, NS = GE, RS = nt, OS = JE, IS = QE, TS = gi, jS = tb, kS = sb, AS = Ts, CS = _i, DS = od, MS = id, VS = vi, LS = wi, FS = cd, zS = Rb, US = js(), qS = st(), KS = ks, GS = Cb, HS = Lb, XS = qb, BS = Hb, JS = Jb, WS = Ei, YS = sS, QS = iS, ZS = lS, xS = fS, eP = yS;
var tP = {
  parse: gS,
  valid: _S,
  clean: vS,
...
const _r = /* @__PURE__ */ ml(tP), rP = Object.prototype.toString, nP = "[object Uint8Array]", sP = "[object ArrayBuffer]";
function ud(e, t, r) {
...
const Wc = "aes-256-cbc", fd = /* @__PURE__ */ new Set([
  "aes-256-cbc",
  "aes-256-gcm",
  "aes-256-ctr"
]), dP = (e) => typeof e == "string" && fd.has(e), yt = () => /* @__PURE__ */ Object.create(null), Yc = (e) => e !== void 0, na = (e, t) => {
...
var At, Ct, cr, Ve, Ge, lr, ur, kr, it, ve, hd, md, pd, yd, $d, gd, _d, vd;
class fP {
  constructor(t = {}) {
    Je(this, ve);
    Wr(this, "path");
    ...
    const r = mt(this, ve, hd).call(this, t);
    Me(this, Ve, r), mt(this, ve, md).call(this, r), mt(this, ve, yd).call(this, r), mt(this, ve, $d).call(this, r), this.events = new EventTarget(), Me(this, Ct, r.encryptionKey), Me(this, cr, r.encryptionAlgorithm ?? Wc), this.path = mt(this, ve, gd).call(this, r), mt(this, ve, _d).call(this, r), r.watch && this._watch();
  }
  get(t, r) {
  ...
  has(t) {
    return W(this, Ve).accessPropertiesByDotNotation ? Ms(this.store, t) : t in this.store;
  }
  appendToArray(t, r) {
    na(t, r);
  ...
  reset(...t) {
    for (const r of t)
      Yc(W(this, Ge)[r]) && this.set(r, W(this, Ge)[r]);
  }
  delete(t) {
    const { store: r } = this;
    W(this, Ve).accessPropertiesByDotNotation ? Cd(r, t) : delete r[t], this.store = r;
  }
  /**
      Delete all items.
  ...
  clear() {
    ...
    for (const r of Object.keys(W(this, Ge)))
      Yc(W(this, Ge)[r]) && (na(r, W(this, Ge)[r]), W(this, Ve).accessPropertiesByDotNotation ? Pn(t, r, W(this, Ge)[r]) : t[r] = W(this, Ge)[r]);
    this.store = t;
  }
  onDidChange(t, r) {
    if (typeof t != "string")
  ...
  */
  ...
  _write(t) {
    ...
    const n = W(this, Ct);
    if (n) {
      const s = Yr.randomBytes(16), a = Yr.pbkdf2Sync(n, s, 1e4, 32, "sha512"), o = Yr.createCipheriv(W(this, cr), a, s), l = ta([o.update(ra(r)), o.final()]), c = [s, ra(":"), l];
    ...
    if (fe.env.SNAP)
      ...
      try {
        hl(this.path, r, { mode: W(this, Ve).configFileMode });
      } catch (s) {
...
At = new WeakMap(), Ct = new WeakMap(), cr = new WeakMap(), Ve = new WeakMap(), Ge = new WeakMap(), lr = new WeakMap(), ur = new WeakMap(), kr = new WeakMap(), it = new WeakMap(), ve = new WeakSet(), hd = function(t) {
  const r = {
    configName: "config",
    fileExtension: "json",
  ...
  if (r.encryptionAlgorithm ?? (r.encryptionAlgorithm = Wc), !dP(r.encryptionAlgorithm))
  ...
  Me(this, At, n.compile(s)), mt(this, ve, pd).call(this, t.schema);
}, pd = function(t) {
  ...
  if (t.migrations) {
    mt(this, ve, vd).call(this, t), this._validate(this.store);
    return;
  }
...
let tl = Ar.readText(), rl = Ar.readImage().toDataURL(), jr = null;
function gP(e) {
  jr && clearInterval(jr), jr = setInterval(() => {
    try {
      const t = Ar.readText(), r = Ar.readImage(), n = r.isEmpty() ? "" : r.toDataURL();
      let s = !1, a = null;
      const o = he.get("settings.maxHistorySize") || 100;
...
function vP(e) {
  at.handle("get-history", () => he.get("history") || []), at.handle("toggle-pin", (t, r) => {
    const n = he.get("history") || [], s = n.findIndex((a) => a.id === r);
