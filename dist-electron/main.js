...
var Pd = (e, t, r) => t in e ? Sd(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r;
var Jr = (e, t, r) => Pd(e, typeof t != "symbol" ? t + "" : t, r), Cs = (e, t, r) => t.has(e) || Pi("Cannot " + r);
var B = (e, t, r) => (Cs(e, t, "read from private field"), r ? r.call(e) : t.get(e)), We = (e, t, r) => t.has(e) ? Pi("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), De = (e, t, r, n) => (Cs(e, t, "write to private field"), n ? n.call(e, r) : t.set(e, r), r), ht = (e, t, r) => (Cs(e, t, "access private method"), r);
import sl, { clipboard as kr, ipcMain as Br, nativeImage as al, app as wr, globalShortcut as ol, Tray as Nd, Menu as Rd, BrowserWindow as il } from "electron";
import { fileURLToPath as Od } from "node:url";
import ne from "node:path";
import fe from "node:process";
import { promisify as Pe, isDeepStrictEqual as Ni } from "node:util";
import Y from "node:fs";
import Yr, { randomFillSync as Id, randomUUID as Td } from "node:crypto";
import Ri from "node:assert";
import cl from "node:os";
import "node:events";
import "node:stream";
import { exec as jd } from "child_process";
const ur = (e) => {
  const t = typeof e;
...
const jt = cl.homedir(), Pa = cl.tmpdir(), { env: Er } = fe, Dd = (e) => {
  const t = ne.join(jt, "Library");
  return {
  ...
  const t = Er.APPDATA || ne.join(jt, "AppData", "Roaming"), r = Er.LOCALAPPDATA || ne.join(jt, "AppData", "Local");
  return {
  ...
  const t = ne.basename(jt);
  return {
    data: ne.join(Er.XDG_DATA_HOME || ne.join(jt, ".local", "share"), e),
    config: ne.join(Er.XDG_CONFIG_HOME || ne.join(jt, ".config"), e),
    cache: ne.join(Er.XDG_CACHE_HOME || ne.join(jt, ".cache"), e),
    // https://wiki.debian.org/XDGBaseDirectorySpecification#state
    log: ne.join(Er.XDG_STATE_HOME || ne.join(jt, ".local", "state"), e),
    temp: ne.join(Pa, t, e)
  };
};
function Ld(e, { suffix: t = "nodejs" } = {}) {
  if (typeof e != "string")
    throw new TypeError(`Expected a string, got ${typeof e}`);
  return t && (e += `-${t}`), fe.platform === "darwin" ? Dd(e) : fe.platform === "win32" ? Md(e) : Vd(e);
}
const Et = (e, t) => {
  const { onError: r } = t;
  return function(...s) {
  ...
  return function(s) {
    const { timeout: a } = s, o = s.interval ?? Fd, l = Date.now() + a;
    return function c(...d) {
  ...
  isChangeErrorOk: (e) => {
    if (!br.isNodeError(e))
      return !1;
    const { code: t } = e;
    return t === "ENOSYS" || !zd && (t === "EINVAL" || t === "EPERM");
  },
...
}, zd = fe.getuid ? !fe.getuid() : !1, Ne = {
  isRetriable: br.isRetriableError
}, Ie = {
  attempt: {
    /* ASYNC */
    chmod: Et(Pe(Y.chmod), Nn),
    chown: Et(Pe(Y.chown), Nn),
    close: Et(Pe(Y.close), Ue),
    fsync: Et(Pe(Y.fsync), Ue),
    mkdir: Et(Pe(Y.mkdir), Ue),
    realpath: Et(Pe(Y.realpath), Ue),
    stat: Et(Pe(Y.stat), Ue),
    unlink: Et(Pe(Y.unlink), Ue),
    /* SYNC */
    chmodSync: mt(Y.chmodSync, Nn),
    chownSync: mt(Y.chownSync, Nn),
  ...
  retry: {
    /* ASYNC */
    close: bt(Pe(Y.close), Ne),
    fsync: bt(Pe(Y.fsync), Ne),
    open: bt(Pe(Y.open), Ne),
    readFile: bt(Pe(Y.readFile), Ne),
    rename: bt(Pe(Y.rename), Ne),
    stat: bt(Pe(Y.stat), Ne),
    write: bt(Pe(Y.write), Ne),
    writeFile: bt(Pe(Y.writeFile), Ne),
    /* SYNC */
    closeSync: St(Y.closeSync, Ne),
    fsyncSync: St(Y.fsyncSync, Ne),
    openSync: St(Y.openSync, Ne),
    readFileSync: St(Y.readFileSync, Ne),
    renameSync: St(Y.renameSync, Ne),
    statSync: St(Y.statSync, Ne),
    writeSync: St(Y.writeSync, Ne),
    writeFileSync: St(Y.writeFileSync, Ne)
  }
}, Ud = "utf8", Ii = 438, qd = 511, Kd = {}, Gd = fe.geteuid ? fe.geteuid() : -1, Hd = fe.getegid ? fe.getegid() : -1, Xd = 1e3, Wd = !!fe.getuid;
fe.getuid && fe.getuid();
const Ti = 128, Jd = (e) => e instanceof Error && "code" in e, ji = (e) => typeof e == "string", Vs = (e) => e === void 0, Bd = fe.platform === "linux", fl = fe.platform === "win32", Na = ["SIGHUP", "SIGINT", "SIGTERM"];
fl || Na.push("SIGALRM", "SIGABRT", "SIGVTALRM", "SIGXCPU", "SIGXFSZ", "SIGUSR2", "SIGTRAP", "SIGSYS", "SIGQUIT", "SIGIOT");
Bd && Na.push("SIGIO", "SIGPOLL", "SIGPWR", "SIGSTKFLT");
class Yd {
  /* CONSTRUCTOR */
  constructor() {
    this.callbacks = /* @__PURE__ */ new Set(), this.exited = !1, this.exit = (t) => {
      if (!this.exited) {
        ...
        for (const r of this.callbacks)
          r();
        t && (fl && t !== "SIGINT" && t !== "SIGTERM" && t !== "SIGKILL" ? fe.kill(fe.pid, "SIGTERM") : fe.kill(fe.pid, t));
      }
    }, this.hook = () => {
...
const Qd = new Yd(), Zd = Qd.register, Te = {
  /* VARIABLES */
  store: {},
  // filePath => purge
  /* API */
...
function hl(e, t, r = Kd) {
  ...
  const s = { timeout: r.timeout ?? Xd };
  let a = null, o = null, l = null;
  try {
    const c = Ie.attempt.realpathSync(e), d = !!c;
    e = c || e, [o, a] = Te.get(e, r.tmpCreate || Te.create, r.tmpPurge !== !1);
    const u = Wd && Vs(r.chown), h = Vs(r.mode);
    if (d && (u || h)) {
      const E = Ie.attempt.statSync(e);
      E && (r = { ...r }, u && (r.chown = { uid: E.uid, gid: E.gid }), h && (r.mode = E.mode));
    }
    if (!d) {
      const E = ne.dirname(e);
      Ie.attempt.mkdirSync(E, {
        mode: qd,
        recursive: !0
      });
    }
    l = Ie.retry.openSync(s)(o, "w", r.mode || Ii), r.tmpCreated && r.tmpCreated(o), ji(t) ? Ie.retry.writeSync(s)(l, t, 0, r.encoding || Ud) : Vs(t) || Ie.retry.writeSync(s)(l, t, 0, t.length, 0), r.fsync !== !1 && (r.fsyncWait !== !1 ? Ie.retry.fsyncSync(s)(l) : Ie.attempt.fsync(l)), Ie.retry.closeSync(s)(l), l = null, r.chown && (r.chown.uid !== Gd || r.chown.gid !== Hd) && Ie.attempt.chownSync(o, r.chown.uid, r.chown.gid), r.mode && r.mode !== Ii && Ie.attempt.chmodSync(o, r.mode);
    try {
      Ie.retry.renameSync(s)(o, e);
    } catch (E) {
      if (!Jd(E) || E.code !== "ENAMETOOLONG")
        throw E;
      Ie.retry.renameSync(s)(o, Te.truncate(e));
    }
    a(), o = null;
  } finally {
    l && Ie.attempt.closeSync(l), o && Te.purge(o);
  }
}
function ml(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var oa = { exports: {} }, pl = {}, tt = {}, Ar = {}, gn = {}, Q = {}, yn = {};
(function(e) {
...
function cf(e, t) {
  return e.scopeValue("func", {
    ref: t,
    code: Ai[t.code] || (Ai[t.code] = new xd._Code(t.code))
  });
}
A.useFunc = cf;
var ca;
...
(function(e) {
  ...
  function _($, { params: m, message: v }, N) {
    const { keyword: R, data: O, schemaValue: K, it: J } = $, { opts: de, propertyName: he, topSchemaRef: ye, schemaPath: z } = J;
...
const df = gn, ff = Q, hf = qe, mf = {
  message: "boolean schema is false"
};
function pf(e) {
  const { gen: t, schema: r, validateName: n } = e;
  r === !1 ? wl(e, !1) : typeof r == "object" && r.$async === !0 ? t.return(hf.default.data) : (t.assign((0, ff._)`${n}.errors`, null), t.return(!0));
}
Ar.topBoolOrEmptySchema = pf;
function yf(e, t) {
  const { gen: r, schema: n } = e;
  n === !1 ? (r.var(t, !1), wl(e)) : r.var(t, !0);
}
Ar.boolOrEmptySchema = yf;
function wl(e, t) {
...
const $f = ["string", "number", "integer", "boolean", "null", "object", "array"], gf = new Set($f);
function _f(e) {
...
const Ef = dr, bf = yt, Sf = gn, Z = Q, Sl = A;
var Nr;
(function(e) {
...
$e.getJSONTypes = Pl;
function Nf(e, t) {
  const { gen: r, data: n, opts: s } = e, a = Rf(t, s.coerceTypes), o = t.length > 0 && !(a.length === 0 && t.length === 1 && (0, bf.schemaHasRulesForType)(e, t[0]));
  if (o) {
    const l = Ia(t, n, s.strictNumbers, Nr.Wrong);
    r.if(l, () => {
      a.length ? Of(e, t, a) : Ta(e);
    });
  }
  return o;
}
...
function la(e, t, r, n = Nr.Correct) {
  const s = n === Nr.Correct ? Z.operators.EQ : Z.operators.NEQ;
  let a;
  switch (e) {
    case "null":
  ...
  return n === Nr.Correct ? a : (0, Z.not)(a);
  function o(l = Z.nil) {
...
te.noPropertyInData = Aa;
function Ol(e) {
  return e ? Object.keys(e).filter((t) => t !== "__proto__") : [];
}
te.allSchemaProperties = Ol;
function Ff(e, t) {
  return Ol(t).filter((r) => !(0, ja.alwaysValidSchema)(e, t[r]));
}
...
te.callValidateCode = zf;
const Uf = (0, le._)`new RegExp`;
function qf({ gen: e, it: { opts: t } }, r) {
  const n = t.unicodeRegExp ? "u" : "", { regExp: s } = t.code, a = s(r, n);
  return e.scopeValue("pattern", {
    key: a.toString(),
    ref: a,
    code: (0, le._)`${s.code === "new RegExp" ? Uf : (0, Cf.useFunc)(e, s)}(${r}, ${n})`
  });
}
te.usePattern = qf;
function Kf(e) {
...
function Jf(e, t) {
  ...
  function E() {
    if (t.errors === !1)
      _(), t.modifying && Di(e), $(() => e.error());
    else {
      const m = t.async ? g() : w();
      t.modifying && Di(e), $(() => Bf(e, m));
    }
  }
  function g() {
  ...
  function _(m = t.async ? (0, je._)`await ` : je.nil) {
    ...
    n.assign(h, (0, je._)`${m}${(0, Hf.callValidateCode)(e, u, v, N)}`, t.modifying);
  }
  function $(m) {
    var v;
...
function Bf(e, t) {
  ...
  r.if((0, je._)`Array.isArray(${t})`, () => {
    r.assign(er.default.vErrors, (0, je._)`${er.default.vErrors} === null ? ${t} : ${er.default.vErrors}.concat(${t})`).assign(er.default.errors, (0, je._)`${er.default.vErrors}.length`), (0, Xf.extendErrors)(e);
  }, () => e.error());
}
...
Mt.getSubschema = xf;
function eh(e, t, { dataProp: r, dataPropType: n, data: s, dataTypes: a, propertyName: o }) {
  if (s !== void 0 && r !== void 0)
    throw new Error('both "data" and "dataProp" passed, only one allowed');
  const { gen: l } = t;
  if (r !== void 0) {
    const { errorPath: d, dataPathArr: u, opts: h } = t, E = l.let("data", (0, it._)`${t.data}${(0, it.getProperty)(r)}`, !0);
    c(E), e.errorPath = (0, it.str)`${d}${(0, Tl.getErrorPath)(r, n, h.jsPropertySyntax)}`, e.parentDataProperty = (0, it._)`${r}`, e.dataPathArr = [...u, e.parentDataProperty];
  }
  if (s !== void 0) {
...
var be = {}, ys = function e(t, r) {
  ...
  return t !== t && r !== r;
}, jl = { exports: {} }, Ct = jl.exports = function(e, t, r) {
    ...
    for (var u in n) {
      ...
      if (Array.isArray(h)) {
        ...
        if (h && typeof h == "object")
          for (var g in h)
            Wn(e, t, r, h[g], s + "/" + u + "/" + rh(g), a, s, u, n, g);
...
const sh = A, ah = ys, oh = nh, ih = /* @__PURE__ */ new Set([
  "type",
  "format",
  "pattern",
  "maxLength",
...
function ch(e, t = !0) {
  return typeof e == "boolean" ? !0 : t === !0 ? !ua(e) : t ? kl(e) <= t : !1;
}
be.inlineRef = ch;
...
function kl(e) {
  ...
  for (const r in e) {
    if (r === "$ref")
      return 1 / 0;
    if (t++, !ih.has(r) && (typeof e[r] == "object" && (0, sh.eachItem)(e[r], (n) => t += kl(n)), t === 1 / 0))
      return 1 / 0;
  }
  return t;
}
...
function hh(e, t) {
  if (typeof e == "boolean")
    return {};
  const { schemaId: r, uriResolver: n } = this.opts, s = Rr(e[r] || t), a = { "": s }, o = Al(n, s, !1), l = {}, c = /* @__PURE__ */ new Set();
  return oh(e, { allKeys: !0 }, (h, E, g, w) => {
    if (w === void 0)
      return;
    const _ = o + E;
    let $ = a[w];
...
const Dl = Ar, Mi = $e, Ca = yt, as = $e, mh = ps, an = lt, Ls = Mt, U = Q, X = qe, ph = be, $t = A, Qr = gn;
function yh(e) {
  if (Ll(e) && (Fl(e), Vl(e))) {
    _h(e);
    return;
...
function Ml({ gen: e, validateName: t, schema: r, schemaEnv: n, opts: s }, a) {
  s.code.es5 ? e.func(t, (0, U._)`${X.default.data}, ${X.default.valCxt}`, n.$async, () => {
    e.code((0, U._)`"use strict"; ${Vi(r, s)}`), gh(e, s), e.code(a);
  }) : e.func(t, (0, U._)`${X.default.data}, ${$h(s)}`, n.$async, () => e.code(Vi(r, s)).code(a));
}
function $h(e) {
...
function _h(e) {
  ...
  Ml(e, () => {
    r.$comment && t.$comment && Ul(e), Sh(e), n.let(X.default.vErrors, null), n.let(X.default.errors, 0), r.unevaluated && vh(e), zl(e), Rh(e);
  });
}
function vh(e) {
...
function Eh(e, t) {
  ...
  s.$comment && r.$comment && Ul(e), Ph(e), Nh(e);
  const a = n.const("_errs", X.default.errors);
  zl(e, a), n.var(t, (0, U._)`${a} === ${X.default.errors}`);
}
function Fl(e) {
  (0, $t.checkUnknownRules)(e), bh(e);
}
function zl(e, t) {
  if (e.opts.jtd)
    return Li(e, [], !1, t);
...
function Rh(e) {
  ...
  r.$async ? t.if((0, U._)`${X.default.errors} === 0`, () => t.return(X.default.data), () => t.throw((0, U._)`new ${s}(${X.default.vErrors})`)) : (t.assign((0, U._)`${n}.errors`, X.default.vErrors), a.unevaluated && Oh(e), t.return((0, U._)`${X.default.errors} === 0`));
}
...
function Li(e, t, r, n) {
  ...
  function h(E) {
    (0, Ca.shouldUseGroup)(a, E) && (E.type ? (s.if((0, as.checkDataType)(E.type, o, c.strictNumbers)), Fi(e, E), t.length === 1 && t[0] === E.type && r && (s.else(), (0, as.reportTypeError)(e)), s.endIf()) : Fi(e, E), l || s.if((0, U._)`${X.default.errors} === ${n || 0}`));
  }
}
function Fi(e, t) {
  ...
  s && (0, mh.assignDefaults)(e, t.type), r.block(() => {
    for (const a of t.rules)
      (0, Ca.shouldUseRule)(n, a) && Gl(e, a.keyword, a.definition, t.type);
  });
}
function Ih(e, t) {
  e.schemaEnv.meta || !e.opts.strictTypes || (Th(e, t), e.opts.allowUnionTypes || jh(e, t), kh(e, e.dataTypes));
}
function Th(e, t) {
  if (t.length) {
    ...
    t.forEach((r) => {
      ql(e.dataTypes, r) || Da(e, `type "${r}" not allowed by context "${e.dataTypes.join(",")}"`);
    }), Ch(e, t);
  }
}
function jh(e, t) {
...
function kh(e, t) {
  ...
  for (const n in r) {
    ...
    if (typeof s == "object" && (0, Ca.shouldUseRule)(e.schema, s)) {
      ...
      a.length && !a.some((o) => Ah(t, o)) && Da(e, `missing type "${a.join(",")}" for keyword "${n}"`);
    }
  }
}
function Ah(e, t) {
...
const Je = Q, Fh = _n, Zt = qe, xe = be, zi = A, zh = tt;
let $s = class {
  constructor(t) {
    var r;
...
function zs(e, { baseId: t, schema: r, root: n }) {
  ...
  for (const l of e.fragment.slice(1).split("/")) {
    if (typeof r == "boolean")
      return;
    const c = r[(0, zi.unescapeFragment)(l)];
    if (c === void 0)
      return;
    r = c;
    const d = typeof r == "object" && r[this.opts.schemaId];
    !Hh.has(l) && d && (t = (0, xe.resolveUrl)(this.opts.uriResolver, t, d));
  }
  let a;
...
const Xh = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", Wh = "Meta-schema for $data reference (JSON AnySchema extension proposal)", Jh = "object", Bh = [
  "$data"
], Yh = {
  $data: {
    type: "string",
...
var Va = {}, _s = { exports: {} };
const xh = RegExp.prototype.test.bind(/^[\da-f]{8}-[\da-f]{4}-[\da-f]{4}-[\da-f]{4}-[\da-f]{12}$/iu), Wl = RegExp.prototype.test.bind(/^(?:(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]\d|\d)\.){3}(?:25[0-5]|2[0-4]\d|1\d{2}|[1-9]\d|\d)$/u);
function Jl(e) {
  let t = "", r = 0, n = 0;
...
function rm(e) {
  ...
  return s.length && (l === Ui ? r.zone = s.join("") : o ? n.push(s.join("")) : n.push(Jl(s))), r.address = n.join(""), r;
}
function Bl(e) {
  if (nm(e, ":") < 2)
...
const { isUUID: im } = Yl, cm = /([\da-z][\d\-a-z]{0,31}):((?:[\w!$'()*+,\-.:;=@]|%[\da-f]{2})+)/iu;
function Ql(e) {
...
const { normalizeIPv6: vm, removeDotSegments: rn, recomposeAuthority: wm, normalizeComponentEncoding: Rn, isIPv4: Em, nonSimpleDomain: bm } = Yl, { SCHEMES: Sm, getSchemeHandler: tu } = _m;
function Pm(e, t) {
...
function ut(e, t) {
  ...
  if (o !== void 0 && (n.reference !== "suffix" && s.push("//"), s.push(o), r.path && r.path[0] !== "/" && s.push("/")), r.path !== void 0) {
    let l = r.path;
    !n.absolutePath && (!a || !a.absolutePath) && (l = rn(l)), o === void 0 && l[0] === "/" && l[1] === "/" && (l = "/%2F" + l.slice(2)), s.push(l);
  }
...
function vt(e, t) {
  ...
  if (a) {
    ...
    if (!r.unicodeSupport && (!o || !o.unicodeSupport) && n.host && (r.domainHost || o && o.domainHost) && s === !1 && bm(n.host))
      try {
...
(function(e) {
  ...
  const n = _n, s = Vr, a = dr, o = Ae, l = Q, c = be, d = $e, u = A, h = Zh, E = Va, g = (P, p) => new RegExp(P, p);
  g.code = "new RegExp";
  ...
  function N(P) {
    var p, S, y, i, f, b, I, j, F, L, se, ze, Lt, Ft, zt, Ut, qt, Kt, Gt, Ht, Xt, Wt, Jt, Bt, Yt;
    const Xe = P.strict, Qt = (p = P.code) === null || p === void 0 ? void 0 : p.optimize, Xr = Qt === !0 || Qt === void 0 ? 1 : Qt || 0, Wr = (y = (S = P.code) === null || S === void 0 ? void 0 : S.regExp) !== null && y !== void 0 ? y : g, As = (i = P.uriResolver) !== null && i !== void 0 ? i : E.default;
    return {
      ...
      strictTypes: (L = (F = P.strictTypes) !== null && F !== void 0 ? F : Xe) !== null && L !== void 0 ? L : "log",
      strictTuples: (ze = (se = P.strictTuples) !== null && se !== void 0 ? se : Xe) !== null && ze !== void 0 ? ze : "log",
      strictRequired: (Ft = (Lt = P.strictRequired) !== null && Lt !== void 0 ? Lt : Xe) !== null && Ft !== void 0 ? Ft : !1,
      code: P.code ? { ...P.code, optimize: Xr, regExp: Wr } : { optimize: Xr, regExp: Wr },
  ...
  class R {
    constructor(p = {}) {
      ...
      p.validateFormats = !1, this.RULES = (0, a.getRules)(), O.call(this, $, p, "NOT SUPPORTED"), O.call(this, m, p, "DEPRECATED", "warn"), this._metaOpts = ye.call(this), p.formats && de.call(this), this._addVocabularies(), this._addDefaultMetaSchema(), p.keywords && he.call(this, p.keywords), typeof p.meta == "object" && this.addMetaSchema(p.meta), J.call(this), p.validateFormats = i;
    }
    _addVocabularies() {
...
const Tm = Vr, qi = te, Ve = Q, pr = qe, Ki = Ae, On = A, jm = {
  keyword: "$ref",
  schemaType: "string",
  code(e) {
    ...
    function h() {
      ...
      return Bn(e, (0, Ve._)`${w}.validate`, d, d.$async);
    }
    function E(w) {
      const _ = au(e, w);
      Bn(e, _, w, w.$async);
...
wt.getValidate = au;
function Bn(e, t, r, n) {
  const { gen: s, it: a } = e, { allErrors: o, schemaEnv: l, opts: c } = a, d = c.passContext ? pr.default.this : Ve.nil;
  n ? u() : h();
  function u() {
    if (!l.$async)
    ...
    const w = s.let("valid");
    s.try(() => {
      s.code((0, Ve._)`await ${(0, qi.callValidateCode)(e, t, d)}`), g(t), o || s.assign(w, !0);
    }, (_) => {
      s.if((0, Ve._)`!(${_} instanceof ${a.ValidationError})`, () => s.throw(_)), E(_), o || s.assign(w, !1);
    }), e.ok(w);
  }
  function h() {
    e.result((0, qi.callValidateCode)(e, t, d), () => g(t), () => E(t));
  }
  function E(w) {
    const _ = (0, Ve._)`${w}.errors`;
    s.assign(pr.default.vErrors, (0, Ve._)`${pr.default.vErrors} === null ? ${_} : ${pr.default.vErrors}.concat(${_})`), s.assign(pr.default.errors, (0, Ve._)`${pr.default.vErrors}.length`);
  }
  function g(w) {
    var _;
    ...
    if (a.props !== !0)
      if ($ && !$.dynamicProps)
        ...
        a.props = On.mergeEvaluated.props(s, m, a.props, Ve.Name);
      }
    if (a.items !== !0)
      if ($ && !$.dynamicItems)
        ...
        a.items = On.mergeEvaluated.items(s, m, a.items, Ve.Name);
      }
  }
}
wt.callRef = Bn;
...
const tr = Q, Fm = A, zm = Wa, Um = {
  ...
  error: Um,
  code(e) {
    const { keyword: t, data: r, schemaCode: n, it: s } = e, a = t === "maxLength" ? tr.operators.GT : tr.operators.LT, o = s.opts.unicode === !1 ? (0, tr._)`${r}.length` : (0, tr._)`${(0, Fm.useFunc)(e.gen, zm.default)}(${r})`;
...
const Km = te, Gm = A, Sr = Q, Hm = {
  ...
  code(e) {
    ...
    if (n) {
      const { regExp: c } = o.opts.code, d = c.code === "new RegExp" ? (0, Sr._)`new RegExp` : (0, Gm.useFunc)(t, c), u = t.let("valid");
      t.try(() => t.assign(u, (0, Sr._)`${d}(${a}, ${l}).test(${r})`), () => t.assign(u, !1)), e.fail$data((0, Sr._)`!${u}`);
    } else {
      const c = (0, Km.usePattern)(e, s);
  ...
  code(e) {
    ...
    function E(g, w) {
      e.setParams({ missingProperty: g }), t.forOf(g, n, () => {
        t.assign(w, (0, Zr.propertyInData)(t, s, g, l.ownProperties)), t.if((0, ln.not)(w), () => {
          e.error(), t.break();
        });
      }, ln.nil);
    }
...
const da = Q, sp = A, ap = vn, op = {
  ...
  code(e) {
    ...
    n || a && typeof a == "object" ? e.fail$data((0, da._)`!${(0, sp.useFunc)(t, ap.default)}(${r}, ${s})`) : e.fail((0, da._)`${a} !== ${r}`);
  }
};
xa.default = ip;
var eo = {};
Object.defineProperty(eo, "__esModule", { value: !0 });
const nn = Q, cp = A, lp = vn, up = {
  ...
  code(e) {
    ...
    let c;
    const d = () => c ?? (c = (0, cp.useFunc)(t, lp.default));
    let u;
    if (l || n)
...
const fp = Ga, hp = Ha, mp = Xa, pp = Ja, yp = Ba, $p = Ya, gp = Qa, _p = Za, vp = xa, wp = eo, Ep = [
  // number
  fp.default,
  hp.default,
  // string
...
function lu(e, t, r = e.schema) {
  ...
  r.forEach((h, E) => {
    (0, Yn.alwaysValidSchema)(l, h) || (n.if((0, Gi._)`${d} > ${E}`, () => e.subschema({
      keyword: o,
      schemaProp: E,
      dataProp: E
    }, c)), e.ok(c));
...
const Hi = Q, Ip = A, Tp = te, jp = Lr, kp = {
  ...
  code(e) {
    ...
    n.items = !0, !(0, Ip.alwaysValidSchema)(n, t) && (s ? (0, jp.validateAdditionalItems)(e, s) : e.ok((0, Tp.validateArray)(e)));
  }
};
no.default = Ap;
var so = {};
...
const Tn = te, Ye = Q, Fp = qe, jn = A, zp = {
...
const qp = tt, Xi = te, qs = A, Wi = ws, Kp = {
  keyword: "properties",
  type: "object",
  schemaType: "object",
  code(e) {
    const { gen: t, schema: r, parentSchema: n, data: s, it: a } = e;
    a.opts.removeAdditional === "all" && n.additionalProperties === void 0 && Wi.default.code(new qp.KeywordCxt(a, Wi.default, "additionalProperties"));
...
const Ji = te, kn = Q, Bi = A, Yi = A, Gp = {
  keyword: "patternProperties",
  type: "object",
  schemaType: "object",
  code(e) {
    const { gen: t, schema: r, data: n, parentSchema: s, it: a } = e, { opts: o } = a, l = (0, Ji.allSchemaProperties)(r), c = l.filter((_) => (0, Bi.alwaysValidSchema)(a, r[_]));
    ...
    a.props !== !0 && !(a.props instanceof kn.Name) && (a.props = (0, Yi.evaluatedPropsToName)(t, a.props));
    const { props: h } = a;
    E();
    function E() {
      for (const _ of l)
    ...
    function g(_) {
      for (const $ in d)
        new RegExp(_).test($) && (0, Bi.checkStrictMode)(a, `property ${$} matches pattern ${_} (use allowMatchingProperties)`);
    }
    function w(_) {
      t.forIn("key", n, ($) => {
        t.if((0, kn._)`${(0, Ji.usePattern)(e, _)}.test(${$})`, () => {
...
const sy = Lr, ay = ro, oy = Fr, iy = no, cy = so, ly = vs, uy = ao, dy = ws, fy = oo, hy = io, my = co, py = lo, yy = uo, $y = fo, gy = ho, _y = mo;
function vy(e = !1) {
  const t = [
    // any
    my.default,
...
const Ks = Q, wy = qe, Zi = Ae, Ey = wt, by = {
...
function fu(e, t) {
  ...
  const s = (0, Ks._)`${wy.default.dynamicAnchors}${(0, Ks.getProperty)(t)}`, a = n.errSchemaPath === "#" ? n.validateName : Sy(e);
...
function Sy(e) {
  ...
  return Zi.compileSchema.call(n, d), (0, Ey.getValidate)(e, d);
}
zr.default = by;
var Ur = {};
Object.defineProperty(Ur, "__esModule", { value: !0 });
Ur.dynamicRef = void 0;
const xi = Q, Py = qe, ec = wt, Ny = {
  keyword: "$dynamicRef",
  schemaType: "string",
...
function hu(e, t) {
  ...
  function o(c) {
    if (s.schemaEnv.root.dynamicAnchors[a]) {
      const d = r.let("_v", (0, xi._)`${Py.default.dynamicAnchors}${(0, xi.getProperty)(a)}`);
...
const ky = zr, Ay = Ur, Cy = yo, Dy = $o, My = [ky.default, Ay.default, Cy.default, Dy.default];
po.default = My;
var go = {}, _o = {};
...
const tc = vs, Vy = {
  ...
  schemaType: "object",
  error: tc.error,
  code: (e) => (0, tc.validatePropertyDeps)(e)
};
_o.default = Vy;
var vo = {};
...
const qy = _o, Ky = vo, Gy = wo, Hy = [qy.default, Ky.default, Gy.default];
go.default = Hy;
var Eo = {}, bo = {};
Object.defineProperty(bo, "__esModule", { value: !0 });
const It = Q, rc = A, Xy = qe, Wy = {
  ...
  code(e) {
    ...
    l instanceof It.Name ? t.if((0, It._)`${l} !== true`, () => t.forIn("key", n, (h) => t.if(d(l, h), () => c(h)))) : l !== !0 && t.forIn("key", n, (h) => l === void 0 ? c(h) : t.if(u(l, h), () => c(h))), a.props = !0, e.ok((0, It._)`${s} === ${Xy.default.errors}`);
    function c(h) {
      if (r === !1) {
        e.setParams({ unevaluatedProperty: h }), e.error(), o || t.break();
        return;
      }
      if (!(0, rc.alwaysValidSchema)(a, r)) {
...
const nr = Q, nc = A, By = {
  ...
  code(e) {
    ...
    else if (typeof r == "object" && !(0, nc.alwaysValidSchema)(s, r)) {
    ...
    function l(c, d) {
      t.forRange("i", d, o, (u) => {
        e.subschema({ keyword: "unevaluatedItems", dataProp: u, dataPropType: nc.Type.Num }, c), s.allErrors || t.if((0, nr.not)(c), () => t.break());
      });
    }
  }
};
So.default = Yy;
Object.defineProperty(Eo, "__esModule", { value: !0 });
const Qy = bo, Zy = So, xy = [Qy.default, Zy.default];
Eo.default = xy;
var Po = {}, No = {};
Object.defineProperty(No, "__esModule", { value: !0 });
const me = Q, e$ = {
...
Object.defineProperty(za, "__esModule", { value: !0 });
const s$ = Ua, a$ = Ka, o$ = to, i$ = po, c$ = go, l$ = Eo, u$ = Po, sc = Cr, d$ = [
  i$.default,
  s$.default,
  a$.default,
  (0, o$.default)(!0),
...
Object.defineProperty(Ro, "__esModule", { value: !0 });
const _r = Q, ha = Es, oc = Ae, f$ = Vr, h$ = A, m$ = {
    ...
    function E() {
      ...
      for (let R = 0; R < o.length; R++) {
        ...
        if (O != null && O.$ref && !(0, h$.schemaHasRulesButRef)(O, a.self.RULES)) {
          const J = O.$ref;
          if (O = oc.resolveRef.call(a.self, a.schemaEnv.root, a.baseId, J), O instanceof oc.SchemaEnv && (O = O.schema), O === void 0)
            throw new f$.default(a.opts.uriResolver, a.baseId, J);
        }
...
const y$ = "https://json-schema.org/draft/2020-12/schema", $$ = "https://json-schema.org/draft/2020-12/schema", g$ = {
  ...
  properties: k$,
  $defs: A$
}, D$ = "https://json-schema.org/draft/2020-12/schema", M$ = "https://json-schema.org/draft/2020-12/meta/unevaluated", V$ = {
  "https://json-schema.org/draft/2020-12/vocab/unevaluated": !0
}, L$ = "meta", F$ = "Unevaluated applicator vocabulary meta-schema", z$ = [
  "object",
  "boolean"
], U$ = {
  unevaluatedItems: {
  ...
  "https://json-schema.org/draft/2020-12/vocab/content": !0
}, X$ = "meta", W$ = "Content vocabulary meta-schema", J$ = [
  "object",
  "boolean"
], B$ = {
  contentEncoding: {
  ...
  "https://json-schema.org/draft/2020-12/vocab/core": !0
}, e0 = "meta", t0 = "Core vocabulary meta-schema", r0 = [
  "object",
  "boolean"
], n0 = {
  $id: {
  ...
  properties: n0,
  $defs: s0
}, o0 = "https://json-schema.org/draft/2020-12/schema", i0 = "https://json-schema.org/draft/2020-12/meta/format-annotation", c0 = {
  "https://json-schema.org/draft/2020-12/vocab/format-annotation": !0
}, l0 = "meta", u0 = "Format vocabulary meta-schema for annotation results", d0 = [
  "object",
  "boolean"
], f0 = {
  format: {
  ...
  type: d0,
  properties: f0
}, m0 = "https://json-schema.org/draft/2020-12/schema", p0 = "https://json-schema.org/draft/2020-12/meta/meta-data", y0 = {
  "https://json-schema.org/draft/2020-12/vocab/meta-data": !0
}, $0 = "meta", g0 = "Meta-data vocabulary meta-schema", _0 = [
  "object",
  "boolean"
], v0 = {
  title: {
  ...
  type: _0,
  properties: v0
}, E0 = "https://json-schema.org/draft/2020-12/schema", b0 = "https://json-schema.org/draft/2020-12/meta/validation", S0 = {
  "https://json-schema.org/draft/2020-12/vocab/validation": !0
}, P0 = "meta", N0 = "Validation vocabulary meta-schema", R0 = [
  "object",
  "boolean"
], O0 = {
  type: {
...
Object.defineProperty(Oo, "__esModule", { value: !0 });
const j0 = P$, k0 = C$, A0 = q$, C0 = Y$, D0 = a0, M0 = h0, V0 = w0, L0 = T0, F0 = ["/properties"];
function z0(e) {
  return [
    j0,
    k0,
...
var U0 = oa.exports, ma = { exports: {} }, mu = {};
(function(e) {
...
var pu = {}, pa = { exports: {} }, yu = {}, rt = {}, Dr = {}, wn = {}, ee = {}, $n = {};
(function(e) {
  Object.defineProperty(e, "__esModule", { value: !0 }), e.regexpCode = e.getEsmExportName = e.getProperty = e.safeStringify = e.stringify = e.strConcat = e.addCodeArg = e.str = e._ = e.nil = e._Code = e.Name = e.IDENTIFIER = e._CodeOrName = void 0;
  class t {
  }
...
C.eachItem = B0;
function ic({ mergeNames: e, mergeToName: t, mergeValues: r, resultToName: n }) {
  return (s, a, o, l) => {
...
function Y0(e, t) {
  return e.scopeValue("func", {
    ref: t,
    code: cc[t.code] || (cc[t.code] = new q0._Code(t.code))
  });
}
C.useFunc = Y0;
var $a;
...
const x0 = wn, eg = ee, tg = ft, rg = {
  message: "boolean schema is false"
};
function ng(e) {
  const { gen: t, schema: r, validateName: n } = e;
  r === !1 ? Eu(e, !1) : typeof r == "object" && r.$async === !0 ? t.return(tg.default.data) : (t.assign((0, eg._)`${n}.errors`, null), t.return(!0));
}
Dr.topBoolOrEmptySchema = ng;
function sg(e, t) {
  const { gen: r, schema: n } = e;
  n === !1 ? (r.var(t, !1), Eu(e)) : r.var(t, !0);
}
Dr.boolOrEmptySchema = sg;
function Eu(e, t) {
  const { gen: r, data: n } = e, s = {
    gen: r,
    keyword: "false schema",
  ...
  (0, x0.reportError)(s, rg, void 0, t);
}
var ge = {}, fr = {};
Object.defineProperty(fr, "__esModule", { value: !0 });
fr.getRules = fr.isJSONType = void 0;
const ag = ["string", "number", "integer", "boolean", "null", "object", "array"], og = new Set(ag);
function ig(e) {
  return typeof e == "string" && og.has(e);
}
fr.isJSONType = ig;
function cg() {
  const e = {
...
const ug = fr, dg = gt, fg = wn, x = ee, Pu = C;
var Or;
(function(e) {
  e[e.Correct = 0] = "Correct", e[e.Wrong = 1] = "Wrong";
})(Or || (ge.DataType = Or = {}));
...
ge.getJSONTypes = Nu;
function mg(e, t) {
  const { gen: r, data: n, opts: s } = e, a = pg(t, s.coerceTypes), o = t.length > 0 && !(a.length === 0 && t.length === 1 && (0, dg.schemaHasRulesForType)(e, t[0]));
  if (o) {
    const l = jo(t, n, s.strictNumbers, Or.Wrong);
    r.if(l, () => {
      a.length ? yg(e, t, a) : ko(e);
    });
  }
  return o;
}
ge.coerceAndCheckDataType = mg;
...
function ga(e, t, r, n = Or.Correct) {
  const s = n === Or.Correct ? x.operators.EQ : x.operators.NEQ;
  let a;
  switch (e) {
    case "null":
  ...
  return n === Or.Correct ? a : (0, x.not)(a);
  function o(l = x.nil) {
...
function wg(e, t) {
  ...
  if (t === "object" && r)
    for (const s in r)
      lc(e, s, r[s].default);
  else t === "array" && Array.isArray(n) && n.forEach((s, a) => lc(e, a, s.default));
}
bs.assignDefaults = wg;
function lc(e, t, r) {
  const { gen: n, compositeRule: s, data: a, opts: o } = e;
  if (r === void 0)
    return;
  ...
  if (s) {
    (0, vg.checkStrictMode)(e, `default is ignored for: ${l}`);
    return;
  }
...
re.checkReportMissingProp = bg;
function Sg({ gen: e, data: t, it: { opts: r } }, n, s) {
  return (0, ue.or)(...n.map((a) => (0, ue.and)(Do(e, t, a, r.ownProperties), (0, ue._)`${s} = ${a}`)));
}
re.checkMissingProp = Sg;
function Pg(e, t) {
  e.setParams({ missingProperty: t }, !0), e.error();
}
re.reportMissingProp = Pg;
function Ou(e) {
  return e.scopeValue("func", {
    // eslint-disable-next-line @typescript-eslint/unbound-method
    ref: Object.prototype.hasOwnProperty,
...
re.propertyInData = Ng;
function Do(e, t, r, n) {
  const s = (0, ue._)`${t}${(0, ue.getProperty)(r)} === undefined`;
  return n ? (0, ue.or)(s, (0, ue.not)(Co(e, t, r))) : s;
}
re.noPropertyInData = Do;
function Iu(e) {
  return e ? Object.keys(e).filter((t) => t !== "__proto__") : [];
}
re.allSchemaProperties = Iu;
function Rg(e, t) {
  return Iu(t).filter((r) => !(0, Ao.alwaysValidSchema)(e, t[r]));
}
re.schemaProperties = Rg;
function Og({ schemaCode: e, data: t, it: { gen: r, topSchemaRef: n, schemaPath: s, errorPath: a }, it: o }, l, c, d) {
...
re.callValidateCode = Og;
const Ig = (0, ue._)`new RegExp`;
function Tg({ gen: e, it: { opts: t } }, r) {
  const n = t.unicodeRegExp ? "u" : "", { regExp: s } = t.code, a = s(r, n);
  return e.scopeValue("pattern", {
    key: a.toString(),
    ref: a,
    code: (0, ue._)`${s.code === "new RegExp" ? Ig : (0, Eg.useFunc)(e, s)}(${r}, ${n})`
  });
}
re.usePattern = Tg;
function jg(e) {
...
const ke = ee, sr = ft, Ag = re, Cg = wn;
function Dg(e, t) {
  const { gen: r, keyword: n, schema: s, parentSchema: a, it: o } = e, l = t.macro.call(o.self, s, a, o), c = Tu(r, n, l);
  o.opts.validateSchema !== !1 && o.self.validateSchema(l, !0);
  const d = r.name("valid");
  e.subschema({
    schema: l,
...
dt.macroKeywordCode = Dg;
function Mg(e, t) {
  var r;
  const { gen: n, keyword: s, schema: a, parentSchema: o, $data: l, it: c } = e;
  Lg(c, t);
  const d = !l && t.compile ? t.compile.call(c.self, a, o, c) : t.validate, u = Tu(n, s, d), h = n.let("valid");
  e.block$data(h, E), e.ok((r = t.valid) !== null && r !== void 0 ? r : h);
  function E() {
    if (t.errors === !1)
      _(), t.modifying && uc(e), $(() => e.error());
    else {
      const m = t.async ? g() : w();
      t.modifying && uc(e), $(() => Vg(e, m));
    }
  }
  function g() {
    const m = n.let("ruleErrs", null);
  ...
  function _(m = t.async ? (0, ke._)`await ` : ke.nil) {
    ...
    n.assign(h, (0, ke._)`${m}${(0, Ag.callValidateCode)(e, u, v, N)}`, t.modifying);
  }
  function $(m) {
    var v;
...
function Vg(e, t) {
  ...
  r.if((0, ke._)`Array.isArray(${t})`, () => {
    r.assign(sr.default.vErrors, (0, ke._)`${sr.default.vErrors} === null ? ${t} : ${sr.default.vErrors}.concat(${t})`).assign(sr.default.errors, (0, ke._)`${sr.default.vErrors}.length`), (0, Cg.extendErrors)(e);
  }, () => e.error());
}
...
dt.validSchemaType = Fg;
function zg({ schema: e, opts: t, self: r, errSchemaPath: n }, s, a) {
  if (Array.isArray(s.keyword) ? !s.keyword.includes(a) : s.keyword !== a)
    throw new Error("ajv implementation error");
  const o = s.dependencies;
  if (o != null && o.some((l) => !Object.prototype.hasOwnProperty.call(e, l)))
...
Vt.getSubschema = Ug;
function qg(e, t, { dataProp: r, dataPropType: n, data: s, dataTypes: a, propertyName: o }) {
  if (s !== void 0 && r !== void 0)
    throw new Error('both "data" and "dataProp" passed, only one allowed');
  const { gen: l } = t;
  if (r !== void 0) {
    const { errorPath: d, dataPathArr: u, opts: h } = t, E = l.let("data", (0, ct._)`${t.data}${(0, ct.getProperty)(r)}`, !0);
    c(E), e.errorPath = (0, ct.str)`${d}${(0, ju.getErrorPath)(r, n, h.jsPropertySyntax)}`, e.parentDataProperty = (0, ct._)`${r}`, e.dataPathArr = [...u, e.parentDataProperty];
  }
  if (s !== void 0) {
...
Vt.extendSubschemaData = qg;
function Kg(e, { jtdDiscriminator: t, jtdMetadata: r, compositeRule: n, createErrors: s, allErrors: a }) {
  n !== void 0 && (e.compositeRule = n), s !== void 0 && (e.createErrors = s), a !== void 0 && (e.allErrors = a), e.jtdDiscriminator = t, e.jtdMetadata = r;
}
Vt.extendSubschemaMode = Kg;
var Se = {}, ku = { exports: {} }, Dt = ku.exports = function(e, t, r) {
  typeof t == "function" && (r = t, t = {}), r = t.cb || r;
  var n = typeof r == "function" ? r : r.pre || function() {
  }, s = r.post || function() {
  };
  ...
  if (n && typeof n == "object" && !Array.isArray(n)) {
    ...
    for (var u in n) {
      ...
      if (Array.isArray(h)) {
        ...
        if (h && typeof h == "object")
          for (var g in h)
            Zn(e, t, r, h[g], s + "/" + u + "/" + Gg(g), a, s, u, n, g);
...
const Xg = C, Wg = ys, Jg = Hg, Bg = /* @__PURE__ */ new Set([
  "type",
  "format",
  "pattern",
  "maxLength",
...
function Yg(e, t = !0) {
  return typeof e == "boolean" ? !0 : t === !0 ? !_a(e) : t ? Au(e) <= t : !1;
}
Se.inlineRef = Yg;
...
function Au(e) {
  ...
  for (const r in e) {
    if (r === "$ref")
      return 1 / 0;
    if (t++, !Bg.has(r) && (typeof e[r] == "object" && (0, Xg.eachItem)(e[r], (n) => t += Au(n)), t === 1 / 0))
      return 1 / 0;
  }
  return t;
}
...
const Mu = Dr, dc = ge, Mo = gt, us = ge, r_ = bs, dn = dt, Gs = Vt, q = ee, W = ft, n_ = Se, _t = C, xr = wn;
function s_(e) {
  if (Fu(e) && (zu(e), Lu(e))) {
    i_(e);
    return;
  }
  Vu(e, () => (0, Mu.topBoolOrEmptySchema)(e));
}
rt.validateFunctionCode = s_;
function Vu({ gen: e, validateName: t, schema: r, schemaEnv: n, opts: s }, a) {
  s.code.es5 ? e.func(t, (0, q._)`${W.default.data}, ${W.default.valCxt}`, n.$async, () => {
    e.code((0, q._)`"use strict"; ${fc(r, s)}`), o_(e, s), e.code(a);
  }) : e.func(t, (0, q._)`${W.default.data}, ${a_(s)}`, n.$async, () => e.code(fc(r, s)).code(a));
}
function a_(e) {
...
function i_(e) {
  const { schema: t, opts: r, gen: n } = e;
  Vu(e, () => {
    r.$comment && t.$comment && qu(e), f_(e), n.let(W.default.vErrors, null), n.let(W.default.errors, 0), r.unevaluated && c_(e), Uu(e), p_(e);
  });
}
function c_(e) {
  const { gen: t, validateName: r } = e;
...
function u_(e, t) {
  ...
  Uu(e, a), n.var(t, (0, q._)`${a} === ${W.default.errors}`);
}
function zu(e) {
...
function p_(e) {
  const { gen: t, schemaEnv: r, validateName: n, ValidationError: s, opts: a } = e;
  r.$async ? t.if((0, q._)`${W.default.errors} === 0`, () => t.return(W.default.data), () => t.throw((0, q._)`new ${s}(${W.default.vErrors})`)) : (t.assign((0, q._)`${n}.errors`, W.default.vErrors), a.unevaluated && y_(e), t.return((0, q._)`${W.default.errors} === 0`));
}
...
function hc(e, t, r, n) {
  ...
  function h(E) {
    (0, Mo.shouldUseGroup)(a, E) && (E.type ? (s.if((0, us.checkDataType)(E.type, o, c.strictNumbers)), mc(e, E), t.length === 1 && t[0] === E.type && r && (s.else(), (0, us.reportTypeError)(e)), s.endIf()) : mc(e, E), l || s.if((0, q._)`${W.default.errors} === ${n || 0}`));
  }
}
function mc(e, t) {
  const { gen: r, schema: n, opts: { useDefaults: s } } = e;
  s && (0, r_.assignDefaults)(e, t.type), r.block(() => {
    for (const a of t.rules)
      (0, Mo.shouldUseRule)(n, a) && Hu(e, a.keyword, a.definition, t.type);
  });
}
function $_(e, t) {
...
const Be = ee, R_ = En, xt = ft, et = Se, pc = C, O_ = rt;
class Ss {
  constructor(t) {
    var r;
    this.refs = {}, this.dynamicAnchors = {};
...
function Lo(e) {
  ...
  if (t)
    return t;
  const r = (0, et.getFullPath)(this.opts.uriResolver, e.root.baseId), { es5: n, lines: s } = this.opts.code, { ownProperties: a } = this.opts, o = new Be.CodeGen(this.scope, { es5: n, lines: s, ownProperties: a });
  let l;
  e.$async && (l = o.scopeValue("Error", {
    ref: R_.default,
...
Fe.resolveRef = I_;
function T_(e) {
  return (0, et.inlineRef)(e.schema, this.opts.inlineRefs) ? e.schema : e.validate ? e : Lo.call(this, e);
}
function Wu(e) {
  for (const t of this._compilations)
    if (j_(t, e))
...
function Ps(e, t) {
  ...
  if (typeof (o == null ? void 0 : o.schema) == "object") {
    if (o.validate || Lo.call(this, o), a === (0, et.normalizeId)(t)) {
      const { schema: l } = o, { schemaId: c } = this.opts, d = l[c];
      return d && (s = (0, et.resolveUrl)(this.opts.uriResolver, s, d)), new Ss({ schema: l, schemaId: c, root: e, baseId: s });
    }
...
function Xs(e, { baseId: t, schema: r, root: n }) {
  ...
  for (const l of e.fragment.slice(1).split("/")) {
    if (typeof r == "boolean")
      return;
    const c = r[(0, pc.unescapeFragment)(l)];
    if (c === void 0)
      return;
    r = c;
    const d = typeof r == "object" && r[this.opts.schemaId];
    !A_.has(l) && d && (t = (0, et.resolveUrl)(this.opts.uriResolver, t, d));
  }
  let a;
...
const C_ = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", D_ = "Meta-schema for $data reference (JSON AnySchema extension proposal)", M_ = "object", V_ = [
  "$data"
], L_ = {
  $data: {
    type: "string",
...
(function(e) {
  ...
  const n = En, s = qr, a = fr, o = Fe, l = ee, c = Se, d = ge, u = C, h = z_, E = Fo, g = (P, p) => new RegExp(P, p);
  g.code = "new RegExp";
  const w = ["removeAdditional", "useDefaults", "coerceTypes"], _ = /* @__PURE__ */ new Set([
    "validate",
    "serialize",
...
const q_ = qr, yc = re, Le = ee, $r = ft, $c = Fe, An = C, K_ = {
  keyword: "$ref",
  schemaType: "string",
  code(e) {
    const { gen: t, schema: r, it: n } = e, { baseId: s, schemaEnv: a, validateName: o, opts: l, self: c } = n, { root: d } = a;
    if ((r === "#" || r === "#/") && s === d.baseId)
      return h();
    const u = $c.resolveRef.call(c, d, s, r);
    if (u === void 0)
      throw new q_.default(n.opts.uriResolver, s, r);
    if (u instanceof $c.SchemaEnv)
      return E(u);
    return g(u);
    function h() {
      if (a === d)
...
hr.getValidate = Bu;
function xn(e, t, r, n) {
  const { gen: s, it: a } = e, { allErrors: o, schemaEnv: l, opts: c } = a, d = c.passContext ? $r.default.this : Le.nil;
  n ? u() : h();
  function u() {
    if (!l.$async)
      throw new Error("async schema referenced by sync schema");
    const w = s.let("valid");
    s.try(() => {
      s.code((0, Le._)`await ${(0, yc.callValidateCode)(e, t, d)}`), g(t), o || s.assign(w, !0);
    }, (_) => {
      s.if((0, Le._)`!(${_} instanceof ${a.ValidationError})`, () => s.throw(_)), E(_), o || s.assign(w, !1);
    }), e.ok(w);
  }
  function h() {
    e.result((0, yc.callValidateCode)(e, t, d), () => g(t), () => E(t));
  }
  function E(w) {
    const _ = (0, Le._)`${w}.errors`;
    s.assign($r.default.vErrors, (0, Le._)`${$r.default.vErrors} === null ? ${_} : ${$r.default.vErrors}.concat(${_})`), s.assign($r.default.errors, (0, Le._)`${$r.default.vErrors}.length`);
  }
  function g(w) {
    var _;
    if (!a.opts.unevaluated)
...
var Ko = {}, Go = {};
Object.defineProperty(Go, "__esModule", { value: !0 });
const ds = ee, Ot = ds.operators, fs = {
...
const fn = ee, B_ = {
  ...
  error: B_,
  code(e) {
    const { gen: t, data: r, schemaCode: n, it: s } = e, a = s.opts.multipleOfPrecision, o = t.let("res"), l = a ? (0, fn._)`Math.abs(Math.round(${o}) - ${o}) > 1e-${a}` : (0, fn._)`${o} !== parseInt(${o})`;
    e.fail$data((0, fn._)`(${n} === 0 || (${o} = ${r}/${n}, ${l}))`);
  }
};
Ho.default = Y_;
var Xo = {}, Wo = {};
...
const ar = ee, Q_ = C, Z_ = Wo, x_ = {
  ...
  error: x_,
  code(e) {
    const { keyword: t, data: r, schemaCode: n, it: s } = e, a = t === "maxLength" ? ar.operators.GT : ar.operators.LT, o = s.opts.unicode === !1 ? (0, ar._)`${r}.length` : (0, ar._)`${(0, Q_.useFunc)(e.gen, Z_.default)}(${r})`;
...
const tv = re, rv = C, Pr = ee, nv = {
  ...
  code(e) {
    const { gen: t, data: r, $data: n, schema: s, schemaCode: a, it: o } = e, l = o.opts.unicodeRegExp ? "u" : "";
    if (n) {
      const { regExp: c } = o.opts.code, d = c.code === "new RegExp" ? (0, Pr._)`new RegExp` : (0, rv.useFunc)(t, c), u = t.let("valid");
  ...
  code(e) {
    ...
    function d() {
      if (c || a)
        ...
        for (const g of r)
          (0, en.checkReportMissingProp)(e, g);
    }
    function u() {
      const g = t.let("missing");
      if (c || a) {
        ...
        t.if((0, en.checkMissingProp)(e, r, g)), (0, en.reportMissingProp)(e, g), t.else();
    }
    function h() {
      t.forOf("prop", n, (g) => {
        e.setParams({ missingProperty: g }), t.if((0, en.noPropertyInData)(t, s, g, l.ownProperties), () => e.error());
      });
    }
    function E(g, w) {
      e.setParams({ missingProperty: g }), t.forOf(g, n, () => {
        t.assign(w, (0, en.propertyInData)(t, s, g, l.ownProperties)), t.if((0, mn.not)(w), () => {
          e.error(), t.break();
        });
      }, mn.nil);
    }
...
const Ws = ge, Ee = ee, fv = C, hv = bn, mv = {
  ...
  code(e) {
    ...
    function g(w, _) {
      const $ = (0, fv.useFunc)(t, hv.default), m = t.name("outer");
...
const va = ee, yv = C, $v = bn, gv = {
  ...
  code(e) {
    const { gen: t, data: r, $data: n, schemaCode: s, schema: a } = e;
    n || a && typeof a == "object" ? e.fail$data((0, va._)`!${(0, yv.useFunc)(t, $v.default)}(${r}, ${s})`) : e.fail((0, va._)`${a} !== ${r}`);
  }
};
xo.default = _v;
var ei = {};
Object.defineProperty(ei, "__esModule", { value: !0 });
const sn = ee, vv = C, wv = bn, Ev = {
  message: "must be equal to one of the allowed values",
  ...
  code(e) {
    ...
    if (l || n)
      ...
      if (!Array.isArray(s))
        throw new Error("ajv implementation error");
      const g = t.const("vSchema", a);
      u = (0, sn.or)(...s.map((w, _) => E(g, _)));
    }
    e.pass(u);
    function h() {
      t.assign(u, !1), t.forOf("v", a, (g) => t.if((0, sn._)`${d()}(${r}, ${g})`, () => t.assign(u, !0).break()));
    }
    function E(g, w) {
      const _ = s[w];
      return typeof _ == "object" && _ !== null ? (0, sn._)`${d()}(${r}, ${g}[${w}])` : (0, sn._)`${r} === ${_}`;
    }
  }
};
ei.default = bv;
Object.defineProperty(Ko, "__esModule", { value: !0 });
const Sv = Go, Pv = Ho, Nv = Xo, Rv = Jo, Ov = Bo, Iv = Yo, Tv = Qo, jv = Zo, kv = xo, Av = ei, Cv = [
  // number
  Sv.default,
  Pv.default,
  // string
...
const gc = ee, es = C, Vv = re, Lv = {
  ...
  code(e) {
    ...
    r.items = !0, !(0, es.alwaysValidSchema)(r, t) && e.ok((0, Vv.validateArray)(e));
  }
};
function xu(e, t, r = e.schema) {
  const { gen: n, parentSchema: s, data: a, keyword: o, it: l } = e;
  u(s), l.opts.unevaluated && r.length && l.items !== !0 && (l.items = es.mergeEvaluated.items(n, r.length, l.items));
  const c = n.name("valid"), d = n.const("len", (0, gc._)`${a}.length`);
  r.forEach((h, E) => {
    (0, es.alwaysValidSchema)(l, h) || (n.if((0, gc._)`${d} > ${E}`, () => e.subschema({
      keyword: o,
      schemaProp: E,
      dataProp: E
    }, c)), e.ok(c));
...
const _c = ee, Uv = C, qv = re, Kv = Kr, Gv = {
  message: ({ params: { len: e } }) => (0, _c.str)`must NOT have more than ${e} items`,
  params: ({ params: { len: e } }) => (0, _c._)`{limit: ${e}}`
}, Hv = {
  keyword: "items",
  type: "array",
  schemaType: ["object", "boolean"],
...
const Dn = re, Qe = ee, Qv = ft, Mn = C, Zv = {
  message: "must NOT have additional properties",
  ...
  code(e) {
    ...
    h(), e.ok((0, Qe._)`${a} === ${Qv.default.errors}`);
    function h() {
      t.forIn("key", s, ($) => {
        !d.length && !u.length ? w($) : t.if(E($), () => w($));
      });
...
const ew = rt, vc = re, Js = C, wc = Ns, tw = {
  keyword: "properties",
  type: "object",
  schemaType: "object",
  code(e) {
    const { gen: t, schema: r, parentSchema: n, data: s, it: a } = e;
    a.opts.removeAdditional === "all" && n.additionalProperties === void 0 && wc.default.code(new ew.KeywordCxt(a, wc.default, "additionalProperties"));
    const o = (0, vc.allSchemaProperties)(r);
    for (const h of o)
      a.definedProperties.add(h);
    ...
    const c = t.name("valid");
    for (const h of l)
      d(h) ? u(h) : (t.if((0, vc.propertyInData)(t, s, h, a.opts.ownProperties)), u(h), a.allErrors || t.else().var(c, !0), t.endIf()), e.it.definedProperties.add(h), e.ok(c);
    function d(h) {
      return a.opts.useDefaults && !a.compositeRule && r[h].default !== void 0;
    }
    function u(h) {
...
const Ec = re, Vn = ee, bc = C, Sc = C, rw = {
  keyword: "patternProperties",
  type: "object",
  schemaType: "object",
  code(e) {
    const { gen: t, schema: r, data: n, parentSchema: s, it: a } = e, { opts: o } = a, l = (0, Ec.allSchemaProperties)(r), c = l.filter((_) => (0, bc.alwaysValidSchema)(a, r[_]));
    if (l.length === 0 || c.length === l.length && (!a.opts.unevaluated || a.props === !0))
      return;
    const d = o.strictSchema && !o.allowMatchingProperties && s.properties, u = t.name("valid");
    a.props !== !0 && !(a.props instanceof Vn.Name) && (a.props = (0, Sc.evaluatedPropsToName)(t, a.props));
    const { props: h } = a;
    E();
    function E() {
      for (const _ of l)
    ...
    function g(_) {
      for (const $ in d)
        new RegExp(_).test($) && (0, bc.checkStrictMode)(a, `property ${$} matches pattern ${_} (use allowMatchingProperties)`);
    }
    function w(_) {
      t.forIn("key", n, ($) => {
        t.if((0, Vn._)`${(0, Ec.usePattern)(e, _)}.test(${$})`, () => {
          const m = c.includes(_);
          m || e.subschema({
            keyword: "patternProperties",
            schemaProp: _,
...
const ts = ee, iw = C, cw = {
  ...
  code(e) {
    ...
    function d() {
      a.forEach((u, h) => {
        let E;
        (0, iw.alwaysValidSchema)(s, u) ? t.var(c, !0) : E = e.subschema({
          keyword: "oneOf",
          schemaProp: h,
          compositeRule: !0
...
const yw = Kr, $w = ri, gw = Gr, _w = ni, vw = si, ww = ed, Ew = ai, bw = Ns, Sw = oi, Pw = ii, Nw = ci, Rw = li, Ow = ui, Iw = di, Tw = fi, jw = hi;
function kw(e = !1) {
  const t = [
    // any
    Nw.default,
  ...
  return e ? t.push($w.default, _w.default) : t.push(yw.default, gw.default), t.push(vw.default), t;
}
ti.default = kw;
var mi = {}, pi = {};
...
Object.defineProperty(zo, "__esModule", { value: !0 });
const Vw = Uo, Lw = Ko, Fw = ti, zw = mi, Nc = Mr, Uw = [
  Vw.default,
  Lw.default,
  (0, Fw.default)(),
  zw.default,
...
const vr = ee, Ea = Rs, Oc = Fe, qw = qr, Kw = C, Gw = {
    ...
    function E() {
      ...
      for (let R = 0; R < o.length; R++) {
        ...
        if (O != null && O.$ref && !(0, Kw.schemaHasRulesButRef)(O, a.self.RULES)) {
          const J = O.$ref;
          if (O = Oc.resolveRef.call(a.self, a.schemaEnv.root, a.baseId, J), O instanceof Oc.SchemaEnv && (O = O.schema), O === void 0)
            throw new qw.default(a.opts.uriResolver, a.baseId, J);
        }
        const K = (g = O == null ? void 0 : O.properties) === null || g === void 0 ? void 0 : g[l];
        if (typeof K != "object")
          throw new Error(`discriminator: oneOf subschemas (or referenced schemas) must have "properties/${l}"`);
...
yi.default = Hw;
const Xw = "http://json-schema.org/draft-07/schema#", Ww = "http://json-schema.org/draft-07/schema#", Jw = "Core schema meta-schema", Bw = {
  schemaArray: {
    type: "array",
    minItems: 1,
    items: {
...
(function(e, t) {
  ...
  const r = yu, n = zo, s = yi, a = Zw, o = ["/properties"], l = "http://json-schema.org/draft-07/schema";
...
(function(e) {
  ...
  const t = xw, r = ee, n = r.operators, s = {
...
(function(e, t) {
  ...
  const r = mu, n = pu, s = ee, a = new s.Name("fullFormats"), o = new s.Name("fastFormats"), l = (d, u = { keywords: !0 }) => {
    if (Array.isArray(u))
...
var eE = ma.exports;
const tE = /* @__PURE__ */ ml(eE), rE = (e, t, r, n) => {
...
${t}`, oE = Object.getOwnPropertyDescriptor(Function.prototype, "toString"), iE = Object.getOwnPropertyDescriptor(Function.prototype.toString, "name"), cE = (e, t, r) => {
  ...
  const { writable: a, enumerable: o, configurable: l } = oE;
...
var ba = { exports: {} };
const uE = "2.0.0", nd = 256, dE = Number.MAX_SAFE_INTEGER || /* istanbul ignore next */
9007199254740991, fE = 16, hE = nd - 6, mE = [
  "major",
  "premajor",
  "minor",
  "preminor",
...
var Sn = ba.exports;
const yE = Object.freeze({ loose: !0 }), $E = Object.freeze({}), gE = (e) => e ? typeof e != "object" ? yE : e : $E;
var $i = gE;
const Tc = /^[0-9]+$/, sd = (e, t) => {
...
const Ln = Is, { MAX_LENGTH: jc, MAX_SAFE_INTEGER: Fn } = Os, { safeRe: zn, t: Un } = Sn, vE = $i, { compareIdentifiers: Bs } = ad;
let wE = class at {
  constructor(t, r) {
    if (r = vE(r), t instanceof at) {
    ...
    if (t.length > jc)
      throw new TypeError(
        `version is longer than ${jc} characters`
      );
  ...
  compare(t) {
    if (Ln("SemVer.compare", this.version, this.options, t), !(t instanceof at)) {
...
var PE = SE;
const NE = Hr, RE = (e, t) => {
  const r = NE(e.trim().replace(/^[=v]+/, ""), t);
  return r ? r.version : null;
};
var OE = RE;
const Ac = Ce, IE = (e, t, r, n, s) => {
...
var kE = jE;
const AE = Ce, CE = (e, t) => new AE(e, t).major;
var DE = CE;
const ME = Ce, VE = (e, t) => new ME(e, t).minor;
var LE = VE;
const FE = Ce, zE = (e, t) => new FE(e, t).patch;
var UE = zE;
const qE = Hr, KE = (e, t) => {
  const r = qE(e, t);
...
var GE = KE;
const Dc = Ce, HE = (e, t, r) => new Dc(e, r).compare(new Dc(t, r));
var nt = HE;
const XE = nt, WE = (e, t, r) => XE(t, e, r);
var JE = WE;
const BE = nt, YE = (e, t) => BE(e, t, !0);
var QE = YE;
const Mc = Ce, ZE = (e, t, r) => {
  const n = new Mc(e, r), s = new Mc(t, r);
  return n.compare(s) || n.compareBuild(s);
};
var gi = ZE;
const xE = gi, eb = (e, t) => e.sort((r, n) => xE(r, n, t));
var tb = eb;
const rb = gi, nb = (e, t) => e.sort((r, n) => rb(n, r, t));
var sb = nb;
...
var vi = mb;
const pb = nt, yb = (e, t, r) => pb(e, t, r) <= 0;
var wi = yb;
const $b = od, gb = id, _b = Ts, vb = vi, wb = _i, Eb = wi, bb = (e, t, r, n) => {
  switch (t) {
    case "===":
...
var cd = bb;
const Sb = Ce, Pb = Hr, { safeRe: qn, t: Kn } = Sn, Nb = (e, t) => {
  if (e instanceof Sb)
    return e;
...
function st() {
  ...
  Ys = t;
  const r = Ib, n = new r(), s = $i, a = js(), o = Is, l = Ce, {
    safeRe: c,
    t: d,
    comparatorTrimReplace: u,
    tildeTrimReplace: h,
    caretTrimReplace: E
  } = Sn, { FLAG_INCLUDE_PRERELEASE: g, FLAG_LOOSE: w } = Os, _ = (T) => T.value === "<0.0.0-0", $ = (T) => T.value === "", m = (T, k) => {
    let V = !0;
    const D = T.slice();
    let G = D.pop();
    for (; V && D.length; )
    ...
    return V;
  }, v = (T, k) => (T = T.replace(c[d.BUILD], ""), o("comp", T, k), T = K(T, k), o("caret", T), T = R(T, k), o("tildes", T), T = de(T, k), o("xrange", T), T = ye(T, k), o("stars", T), T), N = (T) => !T || T.toLowerCase() === "x" || T === "*", R = (T, k) => T.trim().split(/\s+/).map((V) => O(V, k)).join(" "), O = (T, k) => {
  ...
  }, ye = (T, k) => (o("replaceStars", T, k), T.trim().replace(c[d.STAR], "")), z = (T, k) => (o("replaceGTE0", T, k), T.trim().replace(c[k.includePrerelease ? d.GTE0PRE : d.GTE0], "")), H = (T) => (k, V, D, G, M, P, p, S, y, i, f, b) => (N(D) ? V = "" : N(G) ? V = `>=${D}.0.0${T ? "-0" : ""}` : N(M) ? V = `>=${D}.${G}.0${T ? "-0" : ""}` : P ? V = `>=${V}` : V = `>=${V}${T ? "-0" : ""}`, N(y) ? S = "" : N(i) ? S = `<${+y + 1}.0.0-0` : N(f) ? S = `<${y}.${+i + 1}.0-0` : b ? S = `<=${y}.${i}.${f}-${b}` : T ? S = `<${y}.${i}.${+f + 1}-0` : S = `<=${S}`, `${V} ${S}`.trim()), ae = (T, k, V) => {
...
function js() {
  ...
  Qs = t;
  const r = $i, { safeRe: n, t: s } = Sn, a = cd, o = Is, l = Ce, c = st();
  return Qs;
}
const Tb = st(), jb = (e, t, r) => {
  try {
    t = new Tb(t, r);
  } catch {
    return !1;
...
var ks = jb;
const kb = st(), Ab = (e, t) => new kb(e, t).set.map((r) => r.map((n) => n.value).join(" ").trim().split(" "));
var Cb = Ab;
const Db = Ce, Mb = st(), Vb = (e, t, r) => {
...
const Fb = Ce, zb = st(), Ub = (e, t, r) => {
  ...
  return e.forEach((o) => {
    a.test(o) && (!n || s.compare(o) === 1) && (n = o, s = new Fb(n, r));
  }), n;
};
var qb = Ub;
const Zs = Ce, Kb = st(), Fc = Ts, Gb = (e, t) => {
  e = new Kb(e, t);
  let r = new Zs("0.0.0");
...
const Xb = st(), Wb = (e, t) => {
  try {
    return new Xb(e, t).range || "*";
  } catch {
    return null;
  }
};
var Jb = Wb;
const Bb = Ce, ld = js(), { ANY: Yb } = ld, Qb = st(), Zb = ks, zc = Ts, Uc = _i, xb = wi, eS = vi, tS = (e, t, r, n) => {
  e = new Bb(e, n), t = new Qb(t, n);
  let s, a, o, l, c;
  switch (r) {
    case ">":
      s = zc, a = xb, o = Uc, l = ">", c = ">=";
  ...
  for (let d = 0; d < t.set.length; ++d) {
    ...
    let h = null, E = null;
    if (u.forEach((g) => {
      g.semver === Yb && (g = new ld(">=0.0.0")), h = h || g, E = E || g, s(g.semver, h.semver, n) ? h = g : o(g.semver, E.semver, n) && (E = g);
...
var Ei = tS;
const rS = Ei, nS = (e, t, r) => rS(e, t, ">", r);
var sS = nS;
const aS = Ei, oS = (e, t, r) => aS(e, t, "<", r);
var iS = oS;
const qc = st(), cS = (e, t, r) => (e = new qc(e, r), t = new qc(t, r), e.intersects(t, r));
var lS = cS;
const uS = ks, dS = nt;
var fS = (e, t, r) => {
  const n = [];
  let s = null, a = null;
  const o = e.sort((u, h) => dS(u, h, r));
  for (const u of o)
    uS(u, t, r) ? (a = u, s || (s = u)) : (a && n.push([s, a]), a = null, s = null);
  s && n.push([s, null]);
  const l = [];
  for (const [u, h] of n)
...
const Kc = st(), bi = js(), { ANY: xs } = bi, tn = ks, Si = nt, hS = (e, t, r = {}) => {
  if (e === t)
    return !0;
  ...
  return !0;
}, mS = [new bi(">=0.0.0-0")], Gc = [new bi(">=0.0.0")], pS = (e, t, r) => {
  if (e === t)
    return !0;
  if (e.length === 1 && e[0].semver === xs) {
    if (t.length === 1 && t[0].semver === xs)
      return !0;
    r.includePrerelease ? e = mS : e = Gc;
  }
  if (t.length === 1 && t[0].semver === xs) {
  ...
  let s, a;
  for (const g of e)
    g.operator === ">" || g.operator === ">=" ? s = Hc(s, g, r) : g.operator === "<" || g.operator === "<=" ? a = Xc(a, g, r) : n.add(g.semver);
  if (n.size > 1)
    return null;
  let o;
  if (s && a) {
  ...
  for (const g of n) {
    if (s && !tn(g, String(s), r) || a && !tn(g, String(a), r))
      return null;
    for (const w of t)
      if (!tn(g, String(w), r))
        return !1;
  ...
  for (const g of t) {
    if (u = u || g.operator === ">" || g.operator === ">=", d = d || g.operator === "<" || g.operator === "<=", s) {
      if (E && g.semver.prerelease && g.semver.prerelease.length && g.semver.major === E.major && g.semver.minor === E.minor && g.semver.patch === E.patch && (E = !1), g.operator === ">" || g.operator === ">=") {
        if (l = Hc(s, g, r), l === g && l !== s)
          return !1;
      } else if (s.operator === ">=" && !tn(s.semver, String(g), r))
        return !1;
    }
    if (a) {
      if (h && g.semver.prerelease && g.semver.prerelease.length && g.semver.major === h.major && g.semver.minor === h.minor && g.semver.patch === h.patch && (h = !1), g.operator === "<" || g.operator === "<=") {
        if (c = Xc(a, g, r), c === g && c !== a)
          return !1;
      } else if (a.operator === "<=" && !tn(a.semver, String(g), r))
        return !1;
    }
...
var yS = hS;
const ea = Sn, Wc = Os, $S = Ce, Jc = ad, gS = Hr, _S = PE, vS = OE, wS = TE, ES = kE, bS = DE, SS = LE, PS = UE, NS = GE, RS = nt, OS = JE, IS = QE, TS = gi, jS = tb, kS = sb, AS = Ts, CS = _i, DS = od, MS = id, VS = vi, LS = wi, FS = cd, zS = Rb, US = js(), qS = st(), KS = ks, GS = Cb, HS = Lb, XS = qb, WS = Hb, JS = Jb, BS = Ei, YS = sS, QS = iS, ZS = lS, xS = fS, eP = yS;
var tP = {
  parse: gS,
  valid: _S,
  clean: vS,
...
const gr = /* @__PURE__ */ ml(tP), rP = Object.prototype.toString, nP = "[object Uint8Array]", sP = "[object ArrayBuffer]";
function ud(e, t, r) {
  return e ? e.constructor === t ? !0 : rP.call(e) === r : !1;
}
function dd(e) {
  return ud(e, Uint8Array, nP);
}
function aP(e) {
  return ud(e, ArrayBuffer, sP);
}
function oP(e) {
  return dd(e) || aP(e);
}
...
function Hn(e, t = "utf8") {
  return cP(e), Gn[t] ?? (Gn[t] = new globalThis.TextDecoder(t)), Gn[t].decode(e);
}
function lP(e) {
  if (typeof e != "string")
    throw new TypeError(`Expected \`string\`, got \`${typeof e}\``);
}
const uP = new globalThis.TextEncoder();
function ra(e) {
  return lP(e), uP.encode(e);
}
Array.from({ length: 256 }, (e, t) => t.toString(16).padStart(2, "0"));
const Bc = "aes-256-cbc", fd = /* @__PURE__ */ new Set([
  "aes-256-cbc",
  "aes-256-gcm",
  "aes-256-ctr"
]), dP = (e) => typeof e == "string" && fd.has(e), pt = () => /* @__PURE__ */ Object.create(null), Yc = (e) => e !== void 0, na = (e, t) => {
...
var kt, At, ir, Me, Ke, cr, lr, jr, ot, _e, hd, md, pd, yd, $d, gd, _d, vd;
class fP {
  constructor(t = {}) {
    We(this, _e);
    Jr(this, "path");
    ...
    const r = ht(this, _e, hd).call(this, t);
    De(this, Me, r), ht(this, _e, md).call(this, r), ht(this, _e, yd).call(this, r), ht(this, _e, $d).call(this, r), this.events = new EventTarget(), De(this, At, r.encryptionKey), De(this, ir, r.encryptionAlgorithm ?? Bc), this.path = ht(this, _e, gd).call(this, r), ht(this, _e, _d).call(this, r), r.watch && this._watch();
  }
  get(t, r) {
    if (B(this, Me).accessPropertiesByDotNotation)
  ...
  set(t, r) {
    ...
    const { store: n } = this, s = (a, o) => {
      if (na(a, o), B(this, Me).accessPropertiesByDotNotation)
        Pn(n, a, o);
      else {
  ...
  has(t) {
    return B(this, Me).accessPropertiesByDotNotation ? Ms(this.store, t) : t in this.store;
  }
  appendToArray(t, r) {
    na(t, r);
    const n = B(this, Me).accessPropertiesByDotNotation ? this._get(t, []) : t in this.store ? this.store[t] : [];
    if (!Array.isArray(n))
  ...
  reset(...t) {
    for (const r of t)
      Yc(B(this, Ke)[r]) && this.set(r, B(this, Ke)[r]);
  }
  delete(t) {
    const { store: r } = this;
    B(this, Me).accessPropertiesByDotNotation ? Cd(r, t) : delete r[t], this.store = r;
  }
  /**
      Delete all items.
  ...
  clear() {
    const t = pt();
    for (const r of Object.keys(B(this, Ke)))
      Yc(B(this, Ke)[r]) && (na(r, B(this, Ke)[r]), B(this, Me).accessPropertiesByDotNotation ? Pn(t, r, B(this, Ke)[r]) : t[r] = B(this, Ke)[r]);
    this.store = t;
  }
  onDidChange(t, r) {
    if (typeof t != "string")
  ...
  get store() {
    var t;
    try {
      const r = Y.readFileSync(this.path, B(this, At) ? null : "utf8"), n = this._decryptData(r);
      return ((a) => {
        const o = this._deserialize(a);
        return B(this, cr) || this._validate(o), Object.assign(pt(), o);
      })(n);
    } catch (r) {
      if ((r == null ? void 0 : r.code) === "ENOENT")
        return this._ensureDirectory(), pt();
      if (B(this, Me).clearInvalidConfig) {
        const n = r;
  ...
  set store(t) {
    if (this._ensureDirectory(), !Ms(t, Tt))
      try {
        const r = Y.readFileSync(this.path, B(this, At) ? null : "utf8"), n = this._decryptData(r), s = this._deserialize(n);
        Ms(s, Tt) && Pn(t, Tt, Oi(s, Tt));
      } catch {
      }
    B(this, cr) || this._validate(t), this._write(t), this.events.dispatchEvent(new Event("change"));
  }
  *[Symbol.iterator]() {
  ...
  */
  _closeWatcher() {
    B(this, lr) && (B(this, lr).close(), De(this, lr, void 0)), B(this, jr) && (Y.unwatchFile(this.path), De(this, jr, !1)), De(this, ot, void 0);
  }
  _decryptData(t) {
    const r = B(this, At);
    if (!r)
      return typeof t == "string" ? t : Hn(t);
    const n = B(this, ir), s = n === "aes-256-gcm" ? 16 : 0, a = ":".codePointAt(0), o = typeof t == "string" ? t.codePointAt(16) : t[16];
    if (!(a !== void 0 && o === a)) {
      if (n === "aes-256-cbc")
        return typeof t == "string" ? t : Hn(t);
    ...
    const c = (g) => {
      ...
      const { ciphertext: w, authenticationTag: _ } = c(h), $ = Yr.pbkdf2Sync(r, g, 1e4, 32, "sha512"), m = Yr.createDecipheriv(n, $, d);
  ...
  _validate(t) {
    if (!B(this, kt) || B(this, kt).call(this, t) || !B(this, kt).errors)
      return;
    const n = B(this, kt).errors.map(({ instancePath: s, message: a = "" }) => `\`${s.slice(1)}\` ${a}`);
    throw new Error("Config schema violation: " + n.join("; "));
  }
  _ensureDirectory() {
    Y.mkdirSync(ne.dirname(this.path), { recursive: !0 });
  }
  _write(t) {
    let r = this._serialize(t);
    const n = B(this, At);
    if (n) {
      const s = Yr.randomBytes(16), a = Yr.pbkdf2Sync(n, s, 1e4, 32, "sha512"), o = Yr.createCipheriv(B(this, ir), a, s), l = ta([o.update(ra(r)), o.final()]), c = [s, ra(":"), l];
      B(this, ir) === "aes-256-gcm" && c.push(o.getAuthTag()), r = ta(c);
    }
    if (fe.env.SNAP)
      Y.writeFileSync(this.path, r, { mode: B(this, Me).configFileMode });
    else
      try {
        hl(this.path, r, { mode: B(this, Me).configFileMode });
      } catch (s) {
  ...
  _watch() {
    if (this._ensureDirectory(), Y.existsSync(this.path) || this._write(pt()), fe.platform === "win32" || fe.platform === "darwin") {
      B(this, ot) ?? De(this, ot, Ic(() => {
        this.events.dispatchEvent(new Event("change"));
      }, { wait: 100 }));
      const t = ne.dirname(this.path), r = ne.basename(this.path);
      De(this, lr, Y.watch(t, { persistent: !1, encoding: "utf8" }, (n, s) => {
        s && s !== r || typeof B(this, ot) == "function" && B(this, ot).call(this);
      }));
    } else
      B(this, ot) ?? De(this, ot, Ic(() => {
        this.events.dispatchEvent(new Event("change"));
      }, { wait: 1e3 })), Y.watchFile(this.path, { persistent: !1 }, (t, r) => {
        typeof B(this, ot) == "function" && B(this, ot).call(this);
      }), De(this, jr, !0);
  }
  _migrate(t, r, n) {
...
kt = new WeakMap(), At = new WeakMap(), ir = new WeakMap(), Me = new WeakMap(), Ke = new WeakMap(), cr = new WeakMap(), lr = new WeakMap(), jr = new WeakMap(), ot = new WeakMap(), _e = new WeakSet(), hd = function(t) {
  const r = {
    configName: "config",
    fileExtension: "json",
  ...
  if (r.encryptionAlgorithm ?? (r.encryptionAlgorithm = Bc), !dP(r.encryptionAlgorithm))
  ...
  const r = tE.default, n = new U0.Ajv2020({
    allErrors: !0,
    useDefaults: !0,
    ...t.ajvOptions
  });
  ...
  De(this, kt, n.compile(s)), ht(this, _e, pd).call(this, t.schema);
}, pd = function(t) {
  ...
  for (const [n, s] of r) {
    if (!s || typeof s != "object" || !Object.hasOwn(s, "default"))
      continue;
    const { default: a } = s;
    a !== void 0 && (B(this, Ke)[n] = a);
  }
}, yd = function(t) {
  t.defaults && Object.assign(B(this, Ke), t.defaults);
}, $d = function(t) {
  ...
  if (t.migrations) {
    ht(this, _e, vd).call(this, t), this._validate(this.store);
    return;
  }
...
const { app: rs, ipcMain: Sa, shell: hP } = sl;
let Qc = !1;
const Zc = () => {
  if (!Sa || !rs)
  ...
  return Qc || (Sa.on("electron-store-get-data", (t) => {
    t.returnValue = e;
  }), Qc = !0), e;
};
class mP extends fP {
  constructor(t) {
    ...
    } else Sa && rs && ({ defaultCwd: r, appVersion: n } = Zc());
    t = {
      name: "config",
      ...t
  ...
  async openInEditor() {
    const t = await hP.openPath(this.path);
    if (t)
      throw new Error(t);
  }
}
...
let Xn = ns.length;
function yP() {
  return Xn > ns.length - 16 && (Id(ns), Xn = 0), ns.slice(Xn, Xn += 16);
}
const xc = { randomUUID: Td };
function $P(e, t, r) {
  var s;
  e = e || {};
  const n = e.random ?? ((s = e.rng) == null ? void 0 : s.call(e)) ?? yP();
  if (n.length < 16)
    throw new Error("Random bytes length must be >= 16");
  return n[6] = n[6] & 15 | 64, n[8] = n[8] & 63 | 128, pP(n);
}
function el(e, t, r) {
  return xc.randomUUID && !e ? xc.randomUUID() : $P(e);
}
let tl = kr.readText(), rl = kr.readImage().toDataURL(), Tr = null;
function gP(e) {
  Tr && clearInterval(Tr), Tr = setInterval(() => {
    try {
      const t = kr.readText(), r = kr.readImage(), n = r.isEmpty() ? "" : r.toDataURL();
      let s = !1, a = null, o = Ze.get("settings.maxHistorySize") || 100;
      if (t && t !== tl ? (tl = t, s = !0, a = {
        id: el(),
        type: "text",
        content: t,
        timestamp: Date.now(),
        isPinned: !1
      }) : !r.isEmpty() && n !== rl && (rl = n, s = !0, a = {
        id: el(),
        type: "image",
        content: n,
        timestamp: Date.now(),
        ...
        )), l = [...c, ...d], Ze.set("history", l), e.webContents.send("history-updated", l);
      }
    } catch (t) {
...
function _P() {
  Tr && (clearInterval(Tr), Tr = null);
}
function vP(e) {
  Br.handle("get-history", () => Ze.get("history") || []), Br.handle("toggle-pin", (t, r) => {
    let n = Ze.get("history") || [];
    const s = n.findIndex((a) => a.id === r);
    return s !== -1 && (n[s].isPinned = !n[s].isPinned, Ze.set("history", n)), n;
  }), Br.handle("delete-item", (t, r) => {
    let n = Ze.get("history") || [];
    return n = n.filter((s) => s.id !== r), Ze.set("history", n), n;
  }), Br.handle("clear-history", () => {
    let t = Ze.get("history") || [];
    return t = t.filter((r) => r.isPinned), Ze.set("history", t), t;
  }), Br.handle("paste-item", (t, r, n = !1) => {
    const a = (Ze.get("history") || []).find((o) => o.id === r);
    if (a) {
      if (a.type === "text")
        kr.writeText(a.content);
      else if (a.type === "image") {
        if (n)
          return;
        const o = al.createFromDataURL(a.content);
        kr.writeImage(o);
      }
      e.hide(), setTimeout(() => {
        jd(
...
const wd = ne.dirname(Od(import.meta.url));
process.env.APP_ROOT = ne.join(wd, "..");
const ss = process.env.VITE_DEV_SERVER_URL, LP = ne.join(process.env.APP_ROOT, "dist-electron"), Ed = ne.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = ss ? ne.join(process.env.APP_ROOT, "public") : Ed;
let ce, aa;
function bd() {
  ce = new il({
    width: 600,
    ...
    skipTaskbar: !0,
    webPreferences: {
      preload: ne.join(wd, "preload.mjs"),
      nodeIntegration: !1,
      contextIsolation: !0
    }
  }), ss && ce.webContents.openDevTools({ mode: "detach" }), gP(ce), vP(ce), ss ? ce.loadURL(ss) : ce.loadFile(ne.join(Ed, "index.html")), ce.on("blur", () => {
...
wr.whenReady().then(() => {
  wr.dock && wr.dock.hide(), bd();
  const e = al.createEmpty();
  aa = new Nd(e), aa.setToolTip("Glyph Clipboard");
  const t = Rd.buildFromTemplate([
    { label: "Show Glyph", click: () => nl() },
    { type: "separator" },
    { label: "Quit", click: () => wr.quit() }
  ]);
  aa.setContextMenu(t), ol.register("CommandOrControl+Shift+V", () => {
    nl();
  });
});
wr.on("activate", () => {
  il.getAllWindows().length === 0 && bd();
});
export {
  LP as MAIN_DIST,
  Ed as RENDERER_DIST,
