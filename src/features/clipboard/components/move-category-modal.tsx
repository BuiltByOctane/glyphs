    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-2">
          <button
            className={cn(
              "w-full text-left px-3 py-2.5 text-sm rounded-md text-white transition-colors hover:bg-white/10 flex items-center gap-3",
              !item.groupId && "bg-white/10"
            )}
            onClick={() => {
          ...
          {groups.map((g) => {
            ...
            return (
              <button
                key={g.id}
                className={cn(
                  "w-full text-left px-3 py-2.5 text-sm rounded-md text-white transition-colors hover:bg-white/10 flex items-center gap-3 mt-1",
                  item.groupId === g.id && "bg-white/10"
                )}
                onClick={() => {
